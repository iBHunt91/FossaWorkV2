    ...
    try:
        ...
        try:
            ...
            if hasattr(scheduler_service, 'is_initialized') and scheduler_service.is_initialized:
                ...
                logger.warning("Scheduler service not initialized, creating database-only schedule")
...
async def update_schedule(
    ...
    try:
        ...
        logger.info(f"Has update_schedule method: {hasattr(scheduler_service, 'update_schedule') if scheduler_service else False}")
        ...
        if scheduler_service and hasattr(scheduler_service, 'update_schedule'):
            ...
            logger.warning("Scheduler service not available for update")
