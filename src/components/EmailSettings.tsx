...
import { FiSend, FiCheck, FiAlertCircle, FiRefreshCw, FiMail, FiList, FiToggleRight, FiClock, FiInfo } from 'react-icons/fi';
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-between mb-6 p-4 bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/10 rounded-lg border border-blue-200 dark:border-blue-800/50">
            ...
            <div className="flex items-center">
              ...
              <span className={`text-sm font-medium ${preferences.enabled ? 'text-blue-700 dark:text-blue-400' : 'text-gray-500 dark:text-gray-500'}`}>
