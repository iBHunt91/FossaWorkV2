...
async function sendSimpleEmail() {
  try {
    ...
    let port = emailSettings.smtpPort || 587;
    let secure = false;
    ...
    if (emailSettings.useSSL) {
      ...
      // For port 587, secure must be false to allow STARTTLS
      // If a different port is set and useSSL is false, we assume non-SSL or STARTTLS capable
      secure = (port === 465); 
    }
