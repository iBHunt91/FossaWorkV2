...
const configurations = [
  // Test SSL (port 465) configurations first
  {
  ...
  {
    name: "Gmail SSL with TLS options",
    config: {
      host: 'smtp.gmail.com',
      port: 465,
      secure: true,
  ...
  // Then try STARTTLS (port 587) configurations
  {
  ...
  // Try with explicit auth type
  {
    name: "Gmail with explicit LOGIN auth",
    config: {
      host: 'smtp.gmail.com',
      port: 587,
      secure: false,
  ...
  {
    name: "Gmail with explicit PLAIN auth",
    config: {
      host: 'smtp.gmail.com',
      port: 587,
      secure: false,
  ...
  // Also try direct Gmail submission (no local SMTP)
  {
    name: "Gmail direct submission service",
    config: {
      service: 'gmail',
      auth: {
        user: settings.username,
