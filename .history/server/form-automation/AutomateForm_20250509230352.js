        ...
        if (fs.existsSync(scraperDataPath)) {
          ...
          if (workOrder) {
            ...
            if (workOrder.dispensers && workOrder.dispensers.length > 0) {
              ...
              logger.info(`Found ${dispensers.length} dispensers for ${workOrderIdForDataLookup} in scraped_content.json`);
            }
            ...
            logger.warn(`Work order ${workOrderIdForDataLookup} not found in scraped_content.json`);
          }
        } else {
