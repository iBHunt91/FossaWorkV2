...
const addFormPrepLog = (message) => {
  // Process the message to enhance it if needed
  // For example: highlight error messages, colorize type indicators, etc.
  let enhancedMessage = message;
  ...
  // Additional formatting for common patterns in FormPrep logs
  if (message.includes('Dispenser') && (message.includes('of') || message.includes('/'))) {
    enhancedMessage = `🔄 ${message}`;
  }
