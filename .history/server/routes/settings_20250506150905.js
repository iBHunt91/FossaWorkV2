...
import { sendTestPushoverNotification, sendSampleJobPushover } from '../../scripts/notifications/pushoverService.js/index.js';
...
router.post('/email', (req, res) => {
  try {
    const { recipientEmail, showJobId, showStoreNumber, showStoreName, showLocation, showDate, showDispensers, preventReload } = req.body;
