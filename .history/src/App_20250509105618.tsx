        ...
        <div className="hidden md:flex md:w-64 bg-gray-900 flex-col shadow-lg text-gray-300">
          ...
          <div className="flex-grow overflow-y-auto">
            ...
            <nav className="px-3 flex-grow overflow-y-auto space-y-1">
              ...
              <Link
                to="/schedule"
                className={`relative flex items-center px-3 py-2 rounded-md text-sm font-medium transition-colors duration-150 ${location.pathname === '/schedule' ? 'bg-gray-700/50 text-white' : 'text-gray-300 hover:bg-gray-700/30 hover:text-white'}`}
              >
                {location.pathname === '/schedule' && <span className="absolute left-0 top-0 bottom-0 w-1 bg-green-400 rounded-r-md"></span>}
                <FiCalendar className="w-5 h-5 mr-3 text-green-400" />
                Schedule
              </Link>
              {/* ... other links ... */}
              <Link
              ...
              <Link
                to="/job-map"
                className={`relative flex items-center px-3 py-2 rounded-md text-sm font-medium transition-colors duration-150 ${location.pathname === '/job-map' ? 'bg-gray-700/50 text-white' : 'text-gray-300 hover:bg-gray-700/30 hover:text-white'}`}
              >
                {location.pathname === '/job-map' && <span className="absolute left-0 top-0 bottom-0 w-1 bg-green-400 rounded-r-md"></span>}
                <FiMap className="w-5 h-5 mr-3 text-green-400" />
                Job Map
              </Link>
              <Link
                to="/system-logs"
