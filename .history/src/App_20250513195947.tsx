...
const AppContent: React.FC = () => {
  ...
  const loadData = async () => {
    try {
      ...
      const status = await updateScrapeStatus();
      console.log('Reloading data and checking status:', status);
      
      // We no longer need to update the status here as it's handled by the context
      ...
      <div className="flex h-screen bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-200">
        ...
        <div className="hidden md:flex md:w-64 bg-gray-900 flex-col shadow-lg text-gray-300">
          ...
          <div className="px-3 py-4 border-t border-gray-700 space-y-4 flex-shrink-0">
            <h3 className="text-xs uppercase font-semibold text-gray-400 px-1 mb-4 tracking-wider">DATA STATUS</h3>
            {/* Time Info - Enhanced */}
            <div className="space-y-3 px-1 mb-4">
              <div className="flex items-start bg-gray-800/30 p-2.5 rounded-lg border border-gray-700/40">
                <div className="flex-shrink-0 h-7 w-7 flex items-center justify-center rounded-full bg-gray-700/50 mr-3">
            ...
            {/* Scrape Buttons - Improved Styles */}
