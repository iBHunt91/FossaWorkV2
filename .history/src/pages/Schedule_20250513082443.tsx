      ...
      >
        ...
        <div className="flex items-center justify-end p-1.5 border-t border-gray-700/50 relative group">
          ...
          <div className="flex gap-1.5">
            ...
            <button
              className="p-1 bg-gray-500 hover:bg-gray-600 text-white rounded-md transition-colors relative z-20"
              title="More Options"
            >
          ...
          {/* Slide-out menu - Shows on hover - Now appears from left side */}
          <div className="absolute left-0 top-0 z-10 flex items-center bg-gray-800/95 backdrop-blur-md rounded-r-md shadow-lg py-1.5 px-2 
                        transition-all duration-300 ease-in-out origin-left 
                        scale-x-0 opacity-0 group-hover:scale-x-100 group-hover:opacity-100">
            {/* Slide-out menu buttons with text labels */}
            <div className="flex gap-2 items-center">
              ...
              <button
                ...
                className="flex items-center gap-1 px-2 py-1 bg-blue-600 hover:bg-blue-700 text-white rounded-md transition-colors"
                title="Open Visit URL in WorkFossa"
              >
                <FiLogIn className="h-3.5 w-3.5 flex-shrink-0" />
              ...
              <button
                ...
                className="flex items-center gap-1 px-2 py-1 bg-purple-600 hover:bg-purple-700 text-white rounded-md transition-colors"
              ...
              <button
                ...
                className="flex items-center gap-1 px-2 py-1 bg-teal-600 hover:bg-teal-700 text-white rounded-md transition-colors"
              ...
              <button 
                ...
                className="flex items-center gap-1 px-2 py-1 bg-green-600 hover:bg-green-700 text-white rounded-md transition-colors"
              ...
              <button 
                ...
                className="flex items-center gap-1 px-2 py-1 bg-red-600 hover:bg-red-700 text-white rounded-md transition-colors"
