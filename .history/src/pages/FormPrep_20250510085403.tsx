  ...
  const startBatchPolling = () => {
    ...
    const poll = async () => {
        ...
        setBatchJobs(prevJobs => {
          ...
          // Extract fuel progress information using the same logic as single visits
          const fuelProgressFromMessage = extractFuelProgressLocal(jobToUpdate.currentVisitStatus || '');
          if (fuelProgressFromMessage.total > 0) {
            jobToUpdate.currentVisitFuelTotal = fuelProgressFromMessage.total;
            jobToUpdate.currentVisitFuelCurrent = fuelProgressFromMessage.current;
            jobToUpdate.currentVisitFuelType = fuelProgressFromMessage.type;
          }
