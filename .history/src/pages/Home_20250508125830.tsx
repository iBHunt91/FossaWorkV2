                  ...
                  <div 
                    ...
                    className={`relative group p-3 rounded-xl cursor-pointer transition-all duration-300
                      ${storeFilter === store.type 
                        ? `bg-gradient-to-br ${storeStyle.gradient} text-white` 
                        : 'bg-gray-50 dark:bg-gray-700/70 hover:bg-gray-100 dark:hover:bg-gray-700'}
                    `}
                  >
                    <div className="flex flex-col items-center text-center">
                      {/* Store icon */}
                      <div className={`h-10 w-10 rounded-full mb-2 flex items-center justify-center
                        ${storeFilter === store.type 
                          ? 'bg-white/25' 
                          : `${storeStyle.bg}`}`
                      }>
                        <span className="text-lg">{storeStyle.icon}</span>
                      </div>
