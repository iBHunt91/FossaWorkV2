...
const HomeContent = () => {
  ...
  const renderMapPanel = () => {
    ...
    const locationsToShow = inRangeOrders
      ...
      .map(order => ({
        id: order.id,
        // Use the first available location data
        lat: order.coordinates?.latitude || order.location?.latitude || order.clientLocation?.latitude!,
        lng: order.coordinates?.longitude || order.location?.longitude || order.clientLocation?.longitude!,
