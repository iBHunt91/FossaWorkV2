          ...
          {ordersByDate.map((dateGroup) => {
            ...
            return (
              <div key={dateGroup.date} className="mb-8 relative">
                ...
                <div className="space-y-3 ml-4 relative">
...
// Add CSS styles for date-grouped cards
useEffect(() => {
  // Add styles for date-grouped cards
...
// Start of main render
return (
  <div className="bg-gray-50 dark:bg-gray-900 min-h-screen">
    {/* Add DateGroupStyles component here to inject styles */}
    <DateGroupStyles />
    
    {/* Show weekend mode modal if needed */}
    {showWeekendModeModal && (
      <WeekendModeModal
        isOpen={showWeekendModeModal}
        onClose={() => {
          setShowWeekendModeModal(false);
          markWeekendModeAsShown();
        }}
