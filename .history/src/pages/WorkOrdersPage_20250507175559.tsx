...
import { FiRefreshCw, FiMapPin, FiTool, FiFileText, FiCalendar, FiClock, FiAlertCircle, FiCheckCircle, FiInfo, FiBarChart2, FiTag, FiGlobe, FiLink, FiExternalLink, FiFilter } from 'react-icons/fi';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6 animate-fadeIn">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md border border-gray-200 dark:border-gray-700 p-4">
            <div className="flex items-start">
              ...
              <div>
                <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400">Work Order Statistics</h3>
                <p className="text-2xl font-bold text-gray-900 dark:text-white mt-1">{workOrders.length} Total</p>
                
                <div className="mt-3 grid grid-cols-3 gap-3">
                  <div className="bg-gray-50 dark:bg-gray-700/50 rounded-md p-2 text-center">
                    <p className="text-xs text-gray-500 dark:text-gray-400">Due Now</p>
                    <p className="text-lg font-semibold text-accent-red-600 dark:text-accent-red-400">{stats.dueNow}</p>
                  </div>
                  <div className="bg-gray-50 dark:bg-gray-700/50 rounded-md p-2 text-center">
                    <p className="text-xs text-gray-500 dark:text-gray-400">Due Soon</p>
                    <p className="text-lg font-semibold text-accent-amber-600 dark:text-accent-amber-400">{stats.dueSoon}</p>
                  </div>
                  <div className="bg-gray-50 dark:bg-gray-700/50 rounded-md p-2 text-center">
                    <p className="text-xs text-gray-500 dark:text-gray-400">Scheduled</p>
                    <p className="text-lg font-semibold text-accent-green-600 dark:text-accent-green-400">{stats.scheduled}</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md border border-gray-200 dark:border-gray-700 p-4">
            <div className="flex items-start mb-3">
              ...
              <div className="flex-1">
                <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400">Stores ({Object.keys(stats.stores).length})</h3>
                <p className="text-xs text-gray-400 dark:text-gray-500">{workOrders.length} work orders across all locations</p>
              </div>
            </div>
            
            <div className="mt-2 max-h-[180px] overflow-y-auto pr-1 scrollbar-thin">
              <div className="space-y-1.5">
                {stats.allStores.map((store, index) => (
                  <div key={index} className="flex items-center justify-between p-2 rounded-md bg-gray-50 dark:bg-gray-700/50 hover:bg-gray-100 dark:hover:bg-gray-700">
                    <span className="text-xs text-gray-700 dark:text-gray-300 truncate max-w-[200px]">{store.name}</span>
