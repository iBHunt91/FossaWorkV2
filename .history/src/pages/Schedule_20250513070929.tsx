  ...
  const renderJobRow = (order: WorkOrder, dateGroupClass?: string) => {
    ...
    return (
      ...
      >
        ...
        <div className="p-3">
          <div className="grid grid-cols-12 gap-x-3 gap-y-2 items-start"> {/* Ensure items-start for overall grid alignment if needed, but individual items will be centered */}
            {/* Visit Date - Takes 4/12 columns on all screens */}
            <div className="col-span-4"> {/* Container for the section */}
              <div className="flex items-center"> {/* Flex container for icon and text, items-center for vertical alignment */}
            ...
            <div className="col-span-3"> {/* Container for the section */}
              <div className="flex items-center"> {/* Flex container for icon and text, items-center for vertical alignment */}
            ...
            <div className="col-span-5"> {/* Container for the section */}
              <div className="flex items-center"> {/* Flex container for icon and text, items-center for vertical alignment */}
        ...
        <div className="flex items-center justify-end p-1.5 border-t border-gray-700/50 relative group">
          ...
          <div className="flex gap-1">
            ...
            <button
              className="p-1 bg-gray-500 hover:bg-gray-600 text-white rounded transition-colors relative z-20"
              title="More Options"
            >
          ...
          {/* Slide-out menu - Shows on hover */}
          <div className="absolute right-0 top-0 z-10 flex items-center bg-gray-800/90 backdrop-blur-sm rounded-md shadow-lg py-1.5 px-1 
                        transition-all duration-300 ease-in-out origin-right 
                        scale-x-0 opacity-0 group-hover:scale-x-100 group-hover:opacity-100">
            {/* Primary actions (duplicated in slide-out for visual consistency) */}
            <button
              onClick={() => navigate(`/app/form-prep?workOrderId=${order.id}&visitId=${visitNumber}`)}
              className="p-1 bg-blue-500 hover:bg-blue-600 text-white rounded transition-colors mx-0.5"
              title="Go to Form Prep"
            >
              <FiEdit3 className="h-3.5 w-3.5" />
            </button>
            <button
              onClick={(e) => handleViewInstructions(e, order)}
              className="p-1 bg-amber-500 hover:bg-amber-600 text-white rounded transition-colors mx-0.5"
              title="View Full Instructions"
            >
              <FiEye className="h-3.5 w-3.5" />
            </button>
            ...
            <button
              ...
              className="p-1 bg-teal-500 hover:bg-teal-600 text-white rounded transition-colors mx-0.5"
            ...
            <button 
              ...
              className="p-1 bg-green-500 hover:bg-green-600 text-white rounded transition-colors mx-0.5"
            ...
            <button 
              ...
              className="p-1 bg-red-500 hover:bg-red-600 text-white rounded transition-colors mx-0.5"
