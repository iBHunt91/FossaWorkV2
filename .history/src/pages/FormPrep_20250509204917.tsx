                            ...
                            {batchJobs.map((job, index) => {
                              ...
                              >
                                ...
                                <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400 w-1/3">
                                  ...
                                  {(job.status === 'running' || (job.status === 'idle' && job.completedVisits < job.totalVisits && job.totalVisits > 0 && currentBatchJobId === job.jobId)) && 
                                  ...
                                  (job.status === 'running' || (job.status === 'idle' && job.completedVisits < job.totalVisits && job.totalVisits > 0 && currentBatchJobId === job.jobId)) && job.completedVisits < job.totalVisits ? (
                                    <div className="space-y-3 min-w-56 min-h-16">
