      ...
      <>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm overflow-hidden border border-gray-200 dark:border-gray-700 transition-all hover:shadow-md">
            <div className="border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 px-5 py-4 flex justify-between items-center">
            ...
            {activeView === 'weekly' && (
              <div> {/* Remove bg-white dark:bg-gray-800 rounded-lg shadow-sm from this div */}
                ...
                */}
                ...
                <div className="bg-white dark:bg-gray-800 p-3 border-b border-t border-gray-200 dark:border-gray-600 flex items-center justify-between rounded-t-lg"> {/* Changed background */}
                  <div className="flex items-center space-x-2">
                    <div className="flex items-center">
