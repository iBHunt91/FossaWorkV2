  ...
  const renderJobRow = (order: WorkOrder, dateGroupClass?: string) => {
    ...
    return (
      ...
      >
        ...
        {/* Action Buttons Footer - Row of buttons as shown in screenshot */}
        <div className="p-2 border-t border-gray-700/50 flex items-center gap-2">
          ...
          <div className="flex gap-2 flex-1">
            ...
            <button
              ...
              className="flex items-center gap-1 px-3 py-1.5 bg-teal-600 hover:bg-teal-700 text-white rounded transition-colors"
            ...
            <button 
              ...
              className="flex items-center gap-1 px-3 py-1.5 bg-cyan-600 hover:bg-cyan-700 text-white rounded transition-colors"
