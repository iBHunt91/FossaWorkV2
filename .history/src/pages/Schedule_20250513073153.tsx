            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex items-center justify-center gap-1 px-1.5">
                <button 
                  ...
                  className="tooltip-wrapper p-1.5 bg-green-600 hover:bg-green-700 text-white rounded transition-all hover:shadow-md hover:scale-105"
                  aria-label="Rescrape Dispenser Data"
                >
                  <FiRefreshCw className="h-4 w-4" />
                  <span className="tooltip">Rescrape</span>
                </button>
                <button 
                  onClick={(e) => handleClearDispenserData(order.id, e)}
                  className="tooltip-wrapper p-1.5 bg-red-600 hover:bg-red-700 text-white rounded transition-all hover:shadow-md hover:scale-105"
                  aria-label="Clear Dispenser Data"
                >
                  <FiTrash2 className="h-4 w-4" />
                  <span className="tooltip">Clear Data</span>
                </button>
              </div>
            </div>
          </div>
