    ...
    const poll = async () => {
        ...
        setBatchJobs(prevJobs => {
          ...
          if (jobIndex === -1) {
            ...
            return prevJobs; // Return prevJobs directly if job not found
          }

          const updatedJobs = [...prevJobs]; // Create a copy to modify
          const jobToUpdate = { ...updatedJobs[jobIndex] }; // Work on a copy of the job
          ...
          if (response.currentVisitDetailedMessage) {
            const dispenserCountForCurrentVisit = response.dispenserCount;
          ...
          if (response.status === 'completed') {
            ...
            jobToUpdate.completedVisits = jobToUpdate.totalVisits;
