                            ...
                            {formJobs.map((job, index) => {
                              ...
                              return (
                                ...
                                <td className="px-4 py-3 text-sm">
                                  {/* Store & Visit information - now on separate lines */}
                                ...
                                <td className="px-4 py-3 text-sm text-gray-500 dark:text-gray-400">
                                  <div className="flex flex-col"> {/* Main container for vertical alignment */}
                                    ...
                                    {job.status === 'completed' && job.startTime && job.endTime && (
                                      <div className="mt-1.5 inline-flex items-center text-xs text-green-600 dark:text-green-400 bg-green-100 dark:bg-green-900/30 px-2 py-0.5 rounded-md">
                                        <FiCheck className="w-3.5 h-3.5 mr-1.5 flex-shrink-0" />
                                        <span className="font-semibold">
                                          Completed
                                        </span>
                                        <span className="ml-1"> {/* Added ml-1 for spacing */}
                                    ...
                                    {job.status === 'error' && job.startTime && job.endTime && (
                                      <div className="mt-1.5 inline-flex items-center text-xs text-red-600 dark:text-red-400 bg-red-100 dark:bg-red-900/30 px-2 py-0.5 rounded-md">
                                        <FiX className="w-3.5 h-3.5 mr-1.5 flex-shrink-0" />
                                        <span className="font-semibold">
                                          Failed
                                        </span>
                                        <span className="ml-1"> {/* Added ml-1 for spacing */}
