...
const FormPrep: React.FC<{}> = () => {
  ...
  const formatDisplayMessage = (message: string | undefined): string => {
    ...
    // Phase 3: Process forms - ALWAYS use "Processing..." for any form filling/processing activities
    // This prevents fluctuation between different messages during the main processing phase
    if (
      lowerMessage.includes('filling form') || 
      lowerMessage.includes('dispenser') || 
      lowerMessage.includes('processing') ||
      lowerMessage.includes('fuel type') ||
