  ...
  const renderJobRow = (order: WorkOrder, dateGroupClass?: string) => {
    ...
    return (
      ...
      >
        ...
        {/* Action Icons Footer - Compact */}
        <div className="flex items-center justify-end gap-1 p-1.5 border-t border-gray-700/50">
          <button
          ...
          <button
            ...
            className="p-1 bg-teal-500 hover:bg-teal-600 text-white rounded transition-colors"
                        ...
                        <div className="bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-200 font-medium px-4 py-2 flex items-center justify-between">
                          ...
                          <span className="text-xs px-2 py-0.5 rounded-full bg-blue-200 dark:bg-blue-800 text-blue-800 dark:text-blue-200">
                            {ordersForDate.length} job{ordersForDate.length !== 1 ? 's' : ''}
                                              ...
                                              {/* Jobs for this date, with connector lines between them - more compact */}
                      <div className="relative pl-5 border-l-2 border-blue-300 dark:border-blue-700 ml-4 py-1">
                        {ordersForDate.map((order, index) => (
                          <div key={order.id} className="relative mb-3">
                            {/* Connector dot */}
                            <div className="absolute -left-[19px] top-5 w-3.5 h-3.5 rounded-full bg-blue-400 dark:bg-blue-600 border-2 border-white dark:border-gray-800"></div>
