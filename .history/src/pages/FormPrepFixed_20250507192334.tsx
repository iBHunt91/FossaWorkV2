                                  ...
                                  <div className="text-xs text-gray-500 dark:text-gray-400 mt-1 min-h-[3.75rem]">
                                    ...
                                    {job.status === 'completed' 
                                      ...
                                      : job.status === 'idle' || job.status === 'running'
                                        ? (() => {
                                            // Extract fuel type info for better display
                                            const fuelTypeRegex = /processing fuel type:\s*([a-zA-Z0-9\s-]+)\s*\((\d+)\/(\d+)\)/i;
                                            const fuelTypeMatch = job.message.match(fuelTypeRegex);
                                            
                                            // Extract dispenser info if available
                                            const dispenserRegex = /dispenser(?:[\s#]+)(\d+)(?:[^\d]+(\d+)|)/i;
                                            ...
                                            if (fuelTypeMatch && fuelTypeMatch[1] && fuelTypeMatch[2] && fuelTypeMatch[3]) {
                                              ...
                                              const hasDispenser = dispenserMatch && dispenserMatch[1];
                                              
                                              return (
                                                <div className="flex flex-col">
                                                  <div className="flex items-center">
                                                    <span className="px-1.5 py-0.5 bg-primary-100 dark:bg-primary-900/30 text-primary-800 dark:text-primary-400 rounded text-xs inline-flex items-center mr-2">
                                                      <span className="w-1 h-1 bg-primary-500 rounded-full mr-1"></span>
                                                      Fuel Grade: {fuelType}
                                                    </span>
                                                  ...
                                                  {hasDispenser && (
                                                    <div className="flex items-center mt-1.5">
                                                      <span className="px-1.5 py-0.5 bg-purple-100 dark:bg-purple-900/30 text-purple-800 dark:text-purple-400 rounded text-xs inline-flex items-center mr-2">
                                                        <span className="w-1 h-1 bg-purple-500 rounded-full mr-1"></span>
                                                        Dispenser #{dispenserMatch[1]}
                                                      </span>
                                                      {dispenserMatch[2] && (
                                                        <span className="flex items-center text-purple-600 dark:text-purple-400">
                                                          <span className="font-medium">{dispenserMatch[1]}</span>
                                                          <span className="mx-0.5 text-gray-400 dark:text-gray-500">/</span>
                                                          <span>{dispenserMatch[2]}</span>
                                                        </span>
                                                      )}
                                                    </div>
                                                  )}
                                                  ...
                                                  <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-1.5 mt-2 overflow-hidden">
                                                    <div 
                                                      className="h-1.5 rounded-full bg-primary-500 relative overflow-hidden"
