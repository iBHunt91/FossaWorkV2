                              ...
                              >
                                ...
                                <td className="px-4 py-3 whitespace-nowrap">
                                  <div className="space-y-2">
                                    ...
                                    {/* Enhanced Batch Progress Visualization Section */}
                                    {job.status === 'running' && (
                                      <div className="mt-4 pt-3 border-t border-gray-200 dark:border-gray-700">
                                        ...
                                        {/* Dispenser Progress Section - if available in message */}
                                        {job.currentVisitStatus && (() => {
                                          const dispenserInfo = extractDispenserProgress(job.currentVisitStatus || '');
                                          if (dispenserInfo.current > 0 && dispenserInfo.total > 0) {
                                            return (
                                              <div className="mb-3">
                                                <div className="flex justify-between items-center text-xs mb-1">
                                                ...
                                                <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-1.5 overflow-hidden">
                                                  <div 
                                                    ...
                                                    style={{ width: `${Math.round((dispenserInfo.current / Math.max(1, dispenserInfo.total)) * 100)}%` }}
                                                  ></div>
                                                </div>
                                              </div>
                                            );
                                        ...
                                        {/* Fuel Grade Progress Section - if available in message */}
                                        {job.currentVisitStatus && (() => {
                                            ...
                                            return (
                                              <div className="mb-3">
                                                <div className="flex justify-between items-center text-xs mb-1">
                                                  ...
                                                  <span className="font-mono bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300 px-1.5 py-0.5 rounded">
                                                    {fuelInfo.current}/{fuelInfo.total}
                                                  </span>
                                                </div>
                                                <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-1.5 overflow-hidden">
                                                  <div 
                                                    ...
                                                    style={{ width: `${Math.round((fuelInfo.current / Math.max(1, fuelInfo.total)) * 100)}%` }}
                                                  ></div>
                                                </div>
                                              </div>
                                            );
