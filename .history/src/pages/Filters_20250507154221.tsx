      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div className="card animate-fadeIn">
          <div className="flex items-center justify-between">
            ...
            <FiBox className="text-primary-500 dark:text-primary-400 text-xl" />
          </div>
          <div className="mt-3">
        ...
        <div className="card animate-fadeIn delay-100">
          <div className="flex items-center justify-between">
          ...
          <div className="mt-3">
            ...
            <div className="mt-2 h-2 bg-gray-200 dark:bg-gray-700 rounded-full">
              <div 
                className={`h-2 rounded-full transition-all duration-400 ${progressBgColor}`}
        ...
        <div className="card animate-fadeIn delay-200">
          <div className="flex items-center justify-between">
            ...
            <FiAlertTriangle className={`${warningsCount > 0 ? 'text-accent-amber-500 dark:text-accent-amber-400 animate-pulse' : 'text-accent-green-500 dark:text-accent-green-400'} text-xl`} />
          </div>
          <div className="mt-3">
    ...
    return (
      <div className="panel mb-6">
        <div className="panel-header">
          <h3 className="panel-title">Filter Breakdown</h3>
            ...
            <div>
              <div className={`grid ${getGridColumnsClass(presentPairs.length)} gap-4 auto-rows-fr w-full`}>
                {presentPairs.map((pair, idx) => {
                  ...
                  return (
                    <div key={idx} className="card-subtle h-full flex flex-col animate-fadeIn delay-100">
      ...
      {isLoading ? (
        ...
        <>
          ...
          <div className="panel overflow-hidden animate-fadeIn">
            <div className="panel-header">
              <h3 className="panel-title">Filters Required</h3>
                      ...
                      return Array.from(visitGroups.entries()).map(([visitId, visitNeeds]) => {
                        ...
                        return (
                          <div key={visitId} className={`border-b ${getStoreColor(visitNeeds[0]?.storeName || '').border}`}>
                            <div className={`px-4 py-2 ${anyNeedsVerification ? 'bg-accent-amber-50/50 dark:bg-accent-amber-900/10' : 'bg-gray-50/50 dark:bg-gray-800/50'} border-b border-gray-100 dark:border-gray-800 border-l-4 ${getStoreColor(visitNeeds[0]?.storeName || '').border}`}>
                              <div className="flex justify-between items-center">
                                <div className="flex items-center">
                                  ...
                                  {anyNeedsVerification && (
                                    <span 
                                      className="ml-2 badge badge-warning flex items-center"
                                    >
                                      <FiAlertCircle className="mr-1 animate-pulse-slow" /> Needs Verification
                                    </span>
                                  )}
                                </div>
                                        ...
                                        {editingFilterNeed === `${need.orderId}-${need.partNumber}-${index}` ? (
                                          <div className="flex items-center justify-center space-x-1">
                                            <input
                                              type="number"
                                              min="0"
                                              className="w-16 px-2 py-1 text-xs font-medium border dark:border-gray-700 rounded bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-300"
                                          ...
                                          <div className="flex items-center justify-center">
                                            <span className={`inline-flex px-2 py-1 text-xs font-medium ${
                                              ...
                                              'bg-purple-100 dark:bg-purple-900/30 text-purple-800 dark:text-purple-300 border border-purple-200 dark:border-purple-800/30' :
                                              'bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300'
                                            } rounded-full`}>
                                              {need.quantity > 0 ? `${need.quantity}x` : 'Pending'}
                                              {getEditedQuantity(need.orderId, need.partNumber, null) !== null && 
                                                <FiEdit className="ml-1 w-2 h-2" title="Manually edited" />
                                              }
                                        </span>
                                            {needsVerification && (
                                              <div className="flex ml-1 space-x-1">
                                                <button 
                                                  ...
                                                  className="p-1 text-amber-600 dark:text-amber-400 hover:bg-amber-100 dark:hover:bg-amber-900/30 rounded"
                                                  title="Edit quantity"
                                                >
