...
const FormPrep: React.FC<{}> = () => {
  ...
  // Handler to clear single visit job history
  const handleClearSingleHistory = () => {
    setFormJobs([]);
    saveToStorage(userStorageKeys.FORM_JOBS, []);
    addToast('info', 'Single visit history cleared.');
    addDebugLog('SINGLE', 'Cleared single visit history');
  };

  // Handler to clear batch job history
  const handleClearBatchHistory = () => {
    setBatchJobs([]);
    saveToStorage(userStorageKeys.BATCH_JOBS, []);
    addToast('info', 'Batch visit history cleared.');
    addDebugLog('BATCH', 'Cleared batch visit history');
  };
                      ...
                      <div className="flex items-center gap-2">
                        {formJobs.length > 0 && (
                          <button
                            ...
                            className="px-3 py-1.5 rounded-lg text-xs font-medium bg-red-100 hover:bg-red-200 text-red-700 dark:bg-red-900/30 dark:hover:bg-red-900/50 dark:text-red-400 transition-all duration-200 flex items-center gap-1"
                            title="Clear all single visit job history"
                          >
                    ...
                    <div className="border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700/50 px-4 py-3">
                      ...
                      {batchJobs.length > 0 && (
                        <button
                          ...
                          className="px-3 py-1.5 rounded-lg text-xs font-medium bg-red-100 hover:bg-red-200 text-red-700 dark:bg-red-900/30 dark:hover:bg-red-900/50 dark:text-red-400 transition-all duration-200 flex items-center gap-1"
                          title="Clear all batch job history"
                        >
                          <FiX className="h-3.5 w-3.5" />
                          Clear History
                        </button>
