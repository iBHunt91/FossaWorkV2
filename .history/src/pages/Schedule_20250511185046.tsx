        ...
        <div className="p-3">
          <div className="grid grid-cols-12 gap-x-3 gap-y-2 items-start">
            ...
            <div className="flex items-center col-span-4">
              <FiCalendar className={`h-3.5 w-3.5 mr-1.5 ${iconColor} flex-shrink-0`} />
              <div>
            ...
            <div className="flex items-center col-span-3">
              <GiGasPump className={`h-3.5 w-3.5 mr-1.5 ${iconColor} flex-shrink-0`} />
              <div>
            ...
            <div className="flex items-center col-span-5">
              <FiFileText className={`h-3.5 w-3.5 mr-1.5 ${iconColor} flex-shrink-0`} />
