        ...
        <div className="flex flex-col space-y-2 mb-3">
          ...
          {dispenserCount > 0 && (
            <div className="flex items-center text-xs text-gray-600 dark:text-gray-300">
              <GiGasPump className="h-4 w-4 text-gray-500 dark:text-gray-400 mr-2 flex-shrink-0" />
              <span>
          ...
          {filteredInstructionsOnCard && (
            <div className="flex items-start">
              <FiFileText className="h-4 w-4 text-gray-500 dark:text-gray-400 mr-2 flex-shrink-0 mt-0.5" />
              <p className="text-xs text-gray-600 dark:text-gray-300 whitespace-normal break-words">
                {filteredInstructionsOnCard}
              </p>
            </div>
          )}
