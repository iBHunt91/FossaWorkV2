                          ...
                          return (
                            ...
                            >
                              ...
                              <div className="flex items-center justify-between mb-3 pb-2 border-b border-gray-100 dark:border-gray-800">
                                ...
                                {jobs.length > 0 && (
                                  <span className="text-xs font-medium px-2 py-1 rounded-full bg-primary-500 text-white dark:bg-primary-600 dark:text-white shadow-sm">
                                    {jobs.length}
                                  </span>
                                )}
                              </div>
                                  ...
                                  <div className="space-y-2">
                                    {jobs.map((job, idx) => {
                                      ...
                                      return (
                                        <div 
                                          key={job.id || idx} 
                                          className={`p-2 rounded-lg border ${storeStyle.cardBorder} bg-white dark:bg-gray-800 hover:shadow-md transition-all duration-200 cursor-pointer ${
                                          ...
                                          <div className="flex items-center justify-between">
                                            {hasDispenserData && (
                                              <div className="flex items-center text-[10px] text-gray-500 dark:text-gray-400">
                                                ...
                                                <span>{job.dispensers?.length || 0} dispenser{job.dispensers?.length !== 1 ? 's' : ''}</span>
                                              </div>
                                            )}
                                    ...
                                    {jobs.length > 4 && (
                                      <div className="flex justify-center">
                                        <span className="text-xs font-medium py-1 px-3 rounded-full bg-primary-50 dark:bg-primary-900/30 text-primary-600 dark:text-primary-400">
                            ...
                            return (
                              ...
                              >
                                ...
                                <div className="flex items-center justify-between mb-3 pb-2 border-b border-gray-100 dark:border-gray-800">
                                  ...
                                  {jobs.length > 0 && (
                                    <span className="text-xs font-medium px-2 py-1 rounded-full bg-accent-green-500 text-white dark:bg-accent-green-600 dark:text-white shadow-sm">
                                      {jobs.length}
                                    </span>
                                  )}
                                </div>
                                ...
                                <div className="max-h-[200px] overflow-y-auto space-y-2 pr-0.5 scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-600">
                                  {jobs.length === 0 ? (
                                    ...
                                    <div className="space-y-2">
                                      ...
                                      {jobs.length > 4 && (
                                        <div className="flex justify-center">
                                          <span className="text-xs font-medium py-1 px-3 rounded-full bg-accent-green-50 dark:bg-accent-green-900/30 text-accent-green-600 dark:text-accent-green-400">
                                            {jobs.length} total jobs
                                          </span>
                                        </div>
                                      )}
