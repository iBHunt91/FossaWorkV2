...
const HomeContent = () => {
  ...
  const renderMapPanel = () => {
    ...
    const locationsToShow = filteredWorkOrders
      ...
      <div className="mb-4">
        <div className="flex justify-between items-center mb-2">
          ...
          <div>
            <button
              ...
              className="text-xs bg-blue-50 dark:bg-blue-900/30 hover:bg-blue-100 dark:hover:bg-blue-800/30 text-blue-600 dark:text-blue-400 rounded px-2 py-1 transition duration-150"
            >
        ...
        <div className="mt-2 text-center text-xs text-gray-500 dark:text-gray-400">
          {locationsToShow.length === 0 ? (
            ...
            `Showing ${locationsToShow.length} locations`
          )}
        </div>
      </div>
    );
