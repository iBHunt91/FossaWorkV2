                                      ...
                                      <div className="mt-3 pt-2 border-t border-gray-200 dark:border-gray-700">
                                        ...
                                        {job.currentVisitPhase && (
                                          <div className="text-xs text-gray-500 dark:text-gray-400 mt-1 capitalize">
                                            Phase: <span className="font-medium text-indigo-600 dark:text-indigo-400">{job.currentVisitPhase.replace('_', ' ')}</span>
                                          </div>
                                        )}
                                      </div>
                                    )}
                                ...
                                <td className="px-4 py-3 whitespace-nowrap">
                                  <div className="flex space-x-2">
                                    {job.status === 'running' && (
                                      <button
                                        onClick={handleStopBatchProcessing}
                                        className="bg-red-100 hover:bg-red-200 text-red-600 dark:bg-red-900/30 dark:hover:bg-red-900/50 dark:text-red-400 p-1.5 rounded transition-colors"
                                    ...
                                    {job.status === 'completed' && (
                                      <button
                                        className="bg-green-100 hover:bg-green-200 text-green-600 dark:bg-green-900/30 dark:hover:bg-green-900/50 dark:text-green-400 p-1.5 rounded transition-colors"
                                        title="View details"
                                      >
