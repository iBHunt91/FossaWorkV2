                ...
                return (
                  <div 
                    ...
                    className={`relative group flex-grow flex items-center gap-2 rounded-xl py-2.5 px-5 cursor-pointer transition-all duration-200 ${
                      storeFilter === store.type || storeFilter === 'all' 
                        ? getStoreStyles(store.type).dot // Use dot color for active background
                  ...
                  >
                    ...
                    <span className={`
                      font-medium
                      ${storeFilter === store.type || storeFilter === 'all' 
                        ? 'text-white' // Use white text for active state
                    ...
                    <span className={`
                      ...
                      ${storeFilter === store.type || storeFilter === 'all' 
                        ? 'bg-black/20 dark:bg-white/20 text-white' // Adjusted count bubble for active state
