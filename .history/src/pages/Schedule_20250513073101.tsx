          ...
          <div className="absolute right-0 top-0 z-10 rounded-lg shadow-xl py-2 px-0.5
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex items-center justify-center gap-1 px-1.5">
                ...
                <button
                  onClick={(e) => handleViewInstructions(e, order)}
                  className="tooltip-wrapper p-1.5 bg-amber-600 hover:bg-amber-700 text-white rounded transition-all hover:shadow-md hover:scale-105"
                ...
                <button
                  ...
                  className="tooltip-wrapper p-1.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded transition-all hover:shadow-md hover:scale-105"
                  aria-label="Open in WorkFossa"
                >
                  <FiExternalLink className="h-4 w-4" />
                  <span className="tooltip">WorkFossa</span>
                </button>
              </div>
