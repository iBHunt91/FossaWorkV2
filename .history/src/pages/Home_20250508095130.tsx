    ...
    return (
      <div className="pb-8">
        ...
        <div className="mb-8">
          <div className="mb-5 border-b border-gray-200 dark:border-gray-700 p-4">
            <div className="flex items-center">
              <div className="flex-shrink-0 h-10 w-10 bg-blue-50 dark:bg-blue-900/30 rounded-full flex items-center justify-center mr-3">
                <FiActivity className="text-blue-600 dark:text-blue-400" />
              </div>
              <div>
              ...
              <div className="ml-auto">
                <span className="bg-blue-100 dark:bg-blue-900/50 text-blue-800 dark:text-blue-300 text-xs font-medium px-2.5 py-1 rounded-full">
                  {groupedWorkOrders.thisWeek.length} jobs
                </span>
              </div>
            </div>
          </div>

          {groupedWorkOrders.thisWeek.length > 0 ? (
            <>
              {renderOrderGroup(groupedWorkOrders.thisWeek)}
            </>
          ) : (
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow p-6 text-center border border-gray-200 dark:border-gray-700">
              <div className="inline-flex h-14 w-14 items-center justify-center rounded-full bg-blue-50 dark:bg-blue-900/20 mb-3">
                <FiCalendar className="h-7 w-7 text-blue-500 dark:text-blue-400" />
              </div>
        ...
        <div className="mb-8">
          <div className="mb-5 border-b border-gray-200 dark:border-gray-700 p-4">
            <div className="flex items-center">
              <div className="flex-shrink-0 h-10 w-10 bg-green-50 dark:bg-green-900/30 rounded-full flex items-center justify-center mr-3">
              ...
              <div className="ml-auto">
                <span className="bg-green-100 dark:bg-green-900/50 text-green-800 dark:text-green-300 text-xs font-medium px-2.5 py-1 rounded-full">
                  {groupedWorkOrders.nextWeek.length} jobs
                </span>
              </div>
            </div>
          </div>

          {groupedWorkOrders.nextWeek.length > 0 ? (
            <>
              {renderOrderGroup(groupedWorkOrders.nextWeek)}
            </>
          ) : (
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow p-6 text-center border border-gray-200 dark:border-gray-700">
              <div className="inline-flex h-14 w-14 items-center justify-center rounded-full bg-green-50 dark:bg-green-900/20 mb-3">
                <FiCalendar className="h-7 w-7 text-green-500 dark:text-green-400" />
              </div>
              <h3 className="text-base font-medium text-gray-900 dark:text-white mb-1">No upcoming jobs</h3>
              <p className="text-sm text-gray-500 dark:text-gray-400 max-w-md mx-auto">
                There are no jobs scheduled for next week.
              </p>
            </div>
          )}
        </div>
