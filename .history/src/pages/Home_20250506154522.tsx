...
const HomeContent: React.FC = () => {
    ...
    return (
      <>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm overflow-hidden border border-gray-200 dark:border-gray-700 transition-all hover:shadow-md">
            <div className="border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-750 px-5 py-4 flex justify-between items-center">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  {Object.entries(storeDistribution.currentWeek).map(([storeType, count], index) => {
                    ...
                    return (
                      <div 
                        key={storeType} 
                        className={`${storeStyle.boxBg} rounded-lg shadow-sm overflow-hidden transition-transform transform hover:scale-105`}
                      >
                        <div className="p-4 flex flex-col items-center justify-center text-center">
                          ...
                          <span className="text-xs text-gray-200">visits</span>
                        </div>
                      </div>
                    );
                  })}
        ...
        {/* Comment out the original work week settings button block */}
        {/*
        <div className="flex justify-end mb-3">
          <button
            onClick={() => setShowWorkWeekSettings(!showWorkWeekSettings)}
            className="flex items-center text-sm px-3 py-1.5 rounded-md text-gray-600 dark:text-gray-300 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 dark:focus:ring-offset-gray-800 transition-colors duration-150"
            aria-expanded={showWorkWeekSettings}
            aria-controls="work-week-settings-panel" // Add ARIA control for accessibility
          >
    ...
    return (
      ...
      >
        ...
        <div className="p-4">
          ...
          {instructions && (
            <div className="mt-2 bg-gray-50 dark:bg-gray-750 rounded p-3 border border-gray-200 dark:border-gray-700">
      ...
      <>
        ...
        {grouped.thisWeek.length > 0 && (
          <div>
            ...
            {!isActualCurrentWeek && (
              <div className="bg-gray-100 dark:bg-gray-750 p-3 border-b border-gray-200 dark:border-gray-700 flex items-center">
        ...
        {grouped.future.length > 0 && (
          <div>
            {/* Updated header style */}
            <div className="bg-gray-100 dark:bg-gray-750 p-3 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
              <h3 className="font-medium text-gray-800 dark:text-gray-200 flex items-center">
  ...
  return (
    ...
    <div className="h-full">
      ...
      <div className="bg-gray-800 dark:bg-gray-900 text-white rounded-lg shadow-md mb-6 flex flex-col">
        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-700 dark:border-gray-800">
          ...
          <div className="flex items-center space-x-4">
            {/* Sidebar items are already handled elsewhere */}
          </div>
        </div>

        {/* Bottom section - search and action buttons */}
        <div className="flex items-center gap-4 p-4"> {/* Adjusted padding */}
          <div className="relative flex-1">
            ...
            <input
              type="text"
              className="block w-full pl-10 pr-3 py-2 bg-gray-700 dark:bg-gray-800 border border-gray-600 dark:border-gray-700 rounded-md text-gray-200 placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 text-sm transition-colors"
          ...
          <div className="flex items-center space-x-2"> {/* Adjusted spacing */}
            <button
              className="p-2 text-gray-300 hover:text-blue-400 hover:bg-gray-700 dark:hover:bg-gray-800 rounded-md focus:outline-none transition-colors"
              title="Refresh Data"
              onClick={() => {
            ...
            {/* Add Work Week Settings Button Here */}
            <button
              onClick={() => setShowWorkWeekSettings(!showWorkWeekSettings)}
              className={`p-2 rounded-md focus:outline-none transition-colors flex items-center ${showWorkWeekSettings ? 'bg-blue-600 text-white' : 'text-gray-300 hover:text-blue-400 hover:bg-gray-700 dark:hover:bg-gray-800'}`}
              aria-expanded={showWorkWeekSettings}
      ...
      {/* Work Week Settings Panel - Placed correctly after toolbar, before main content */}
      {showWorkWeekSettings && (
         <div
           id="work-week-settings-panel"
           className="bg-white dark:bg-gray-800 rounded-lg p-4 mb-4 border border-gray-200 dark:border-gray-700 shadow-sm transition-all duration-300 ease-in-out"
         >
           ...
           <div className="grid grid-cols-2 gap-4">
            ...
            {/* Add explanation about the 5pm weekend mode transition */}
            <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">
              Note: The dashboard automatically displays the <strong>next</strong> work week's schedule after 5:00 PM on the selected 'End of Work Week' day.
            </p>
            {/* Add explanation about job filtering based on work week */}
            <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">
              The weekly dashboard views will primarily focus on jobs scheduled between your selected start and end days.
            </p>
          </div>
        )}

      {/* Main Content Area Wrapper */}
      <div className={`flex-grow ${isFullscreenMode ? 'fixed inset-0 z-50 bg-white dark:bg-gray-900 p-4 overflow-auto' : ''}`}>
        {isFullscreenMode && (
        ...
        {isLoading ? (
          ...
          <>
            {/* Weekly view */}
            {activeView === 'weekly' && (
              <div> {/* Remove bg-white dark:bg-gray-800 rounded-lg shadow-sm from this div */}
                {/* Remove the Work Orders header section */}
                {/* 
                ...
                */}
                ...
                <div className="bg-gray-50 dark:bg-gray-750 p-3 border-b border-t border-gray-200 dark:border-gray-600 flex items-center justify-between rounded-t-lg"> {/* Changed background */}
                  <div className="flex items-center space-x-2">
                    <div className="flex items-center">
                      <h3 className="font-medium text-gray-700 dark:text-gray-300 flex items-center text-sm"> {/* Changed font size */}
                        <FiCalendar className="mr-2 text-blue-500" />
                        <span className="font-semibold text-base"> {/* Changed font weight/size */} 
                ...
                {/* Job list container now needs its own background and rounding */}
                <div className="divide-y divide-gray-200 dark:divide-gray-700 bg-white dark:bg-gray-800 rounded-b-lg shadow-sm"> {/* Added bg, rounded-b, shadow */}
                  {filteredWorkOrders.length === 0 ? (
                    <div className="p-6 text-center text-gray-500 dark:text-gray-400">
                      No work orders found with the current filters.
                    </div>
                  ) : (
                    // Replace IIFE with function call, passing grouped data
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm">
                ...
                <div className="grid grid-cols-7 gap-px bg-gray-200 dark:bg-gray-700">
                  ...
                  {Array.from({ length: new Date(currentYear, currentMonth + 1, 0).getDate() + new Date(currentYear, currentMonth, 1).getDay() }, (_, i) => {
                    ...
                    // Use the pre-calculated grouped data for the calendar day
                    const dayJobs = [
                      ...groupedWorkOrders.thisWeek,
                      ...groupedWorkOrders.nextWeek,
                      ...groupedWorkOrders.future,
                      ...groupedWorkOrders.past,
                      ...groupedWorkOrders.noDate
                    ].filter(order => {
          ...
          <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            >
              <div className="bg-white dark:bg-gray-800 px-6 pt-5 pb-6">
                ...
                <div className="flex bg-gray-100 dark:bg-gray-700 rounded-lg p-1 mb-4">
                  ...
                  >
                    <span className="flex items-center justify-center">
                      ...
                      {/* Conditional rendering for the tab name based on the workaround */}
                      {logConsoleType === 'server' ? 'Equipment (Server logs N/A)' : 'Server'}
                    </span>
                  </button>
                </div>
                ...
                <div className="mt-2">
                  <ScrapeLogsConsole 
                    type={logConsoleType === 'server' ? 'dispenser' : logConsoleType}
                    showHeader={true}
                    height="450px"
                    autoScroll={true}
                  />
