      ...
      >
        ...
        <div className="p-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-3">
            {hasNextVisit && (
              <div className="flex items-start">
                <div className="flex-shrink-0 mt-0.5 mr-2">
                  <FiCalendar className={`h-4 w-4 ${storeStyle.text}`} /> {/* Applied storeStyle.text */}
                </div>
                <div>
            ...
            {dispenserQty > 0 && (
              <div className="flex items-start"> {/* Container for icon and text */}
                <div className="flex-shrink-0 mt-0.5 mr-2"> {/* Icon wrapper */}
                  <GiGasPump className={`h-5 w-5 ${storeStyle.text}`} /> {/* Made icon slightly larger to match potential text size */}
                </div>
                <div>
          ...
          <div className="mt-3 flex flex-wrap items-center justify-between border-t border-gray-200 dark:border-gray-700 pt-3">
            <div className="flex items-center">
              ...
              <span className={`text-xs font-medium ${storeStyle.text}`}>Custom Instructions</span> {/* Applied storeStyle.text */}
            </div>
