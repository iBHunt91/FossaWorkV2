            ...
            <div className="flex flex-wrap gap-3 mt-3">
              {storeDistributionArray.map((store) => (
                <div 
                  ...
                  className={`relative group flex items-center gap-2 rounded-full py-2 px-4 cursor-pointer transition-all duration-200 ${
                ...
                >
                  ...
                  <span className={`
                    text-sm ml-1 px-2 py-0.5 rounded-full 
                    ${storeFilter === store.type || storeFilter === 'all' 
