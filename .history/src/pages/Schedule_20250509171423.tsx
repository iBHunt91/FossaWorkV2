  ...
  const renderJobRow = (order: WorkOrder, dateGroupClass?: string) => {
    ...
    return (
      ...
      >
        ...
        {/* Instructions Display - As per screenshot from Home.tsx */}
        {rawProcessedInstructions && rawProcessedInstructions !== 'No specific instructions provided.' && rawProcessedInstructions !== 'No instructions provided.' && (
