...
import { 
  ...
  FiGlobe,
  FiDatabase,
  FiEye  // Add FiEye icon for our new button
} from 'react-icons/fi'
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
                ...
                <div className="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 p-4 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      className="flex items-center gap-1 py-1.5 px-3 bg-primary-50 dark:bg-primary-900/30 text-primary-700 dark:text-primary-300 rounded-md hover:bg-primary-100 dark:hover:bg-primary-800/40 transition-colors"
                      onClick={goToCurrentWeek}
                      title="Go to Current Week"
                    >
                      <FiCalendar className="h-4 w-4" />
                ...
                <div className="p-3 sm:p-4 bg-gray-50 dark:bg-gray-800/50 border-b border-gray-200 dark:border-gray-700 flex flex-wrap items-center justify-between gap-2">
                  <div className="flex items-center flex-wrap gap-1 sm:gap-2">
                    ...
                    <button
                      className={`px-2 py-1 sm:px-3 sm:py-1.5 rounded-md text-xs sm:text-sm flex items-center ${activeFilter === '7-eleven' 
                        ? 'bg-accent-green-100 dark:bg-accent-green-900/50 text-accent-green-800 dark:text-accent-green-300 font-medium' 
                        : 'bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-600'}`}
                      onClick={() => setActiveFilter('7-eleven')}
                    >
                      7-11
                    ...
                    <button
                      className={`px-2 py-1 sm:px-3 sm:py-1.5 rounded-md text-xs sm:text-sm flex items-center ${activeFilter === 'circle-k' 
                        ? 'bg-accent-amber-100 dark:bg-accent-amber-900/50 text-accent-amber-800 dark:text-accent-amber-300 font-medium' 
                        : 'bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-600'}`}
                      onClick={() => setActiveFilter('circle-k')}
                    >
                      Circle K
                    ...
                    <button
                      className={`px-2 py-1 sm:px-3 sm:py-1.5 rounded-md text-xs sm:text-sm flex items-center ${activeFilter === 'wawa' 
                        ? 'bg-accent-purple-100 dark:bg-accent-purple-900/50 text-accent-purple-800 dark:text-accent-purple-300 font-medium' 
                        : 'bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-600'}`}
                      onClick={() => setActiveFilter('wawa')}
                    >
                      Wawa
                    ...
                    <button
                      className={`px-2 py-1 sm:px-3 sm:py-1.5 rounded-md text-xs sm:text-sm flex items-center ${activeFilter === 'other' 
                        ? 'bg-secondary-100 dark:bg-secondary-900/50 text-secondary-800 dark:text-secondary-300 font-medium' 
                        : 'bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-600'}`}
                      onClick={() => setActiveFilter('other')}
                    >
                      Other
                  ...
                  {activeFilter !== 'all' && (
                    <button
                      className="text-xs text-accent-red-500 dark:text-accent-red-400 hover:text-accent-red-700 dark:hover:text-accent-red-300 flex items-center"
                      onClick={() => setActiveFilter('all')}
                    >
                      <FiX className="h-3.5 w-3.5 mr-1" /> Clear Filter
                    </button>
                ...
                {/* Compact calendar-style weekly view */}
                <div className="p-4">
                  {/* Current Week Calendar */}
                  <div className="bg-white dark:bg-gray-800 rounded-lg overflow-hidden shadow-md border border-gray-200 dark:border-gray-700 mb-6 animate-fadeIn">
                    {/* Week header */}
                    <div className="bg-primary-50 dark:bg-primary-900/20 p-3 border-b border-gray-200 dark:border-gray-700 flex items-center">
                      <div className="h-10 w-10 rounded-full bg-primary-100 dark:bg-primary-900/40 flex items-center justify-center mr-3 shadow-sm">
                        <FiActivity className="text-primary-600 dark:text-primary-400" />
                      </div>
                      <div>
                        <h2 className="font-semibold text-gray-800 dark:text-white">Current Week</h2>
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                          {formatDateRange(
                            workWeekDates.currentWeekStart,
                            workWeekDates.currentWeekEnd
                          )}
                        </p>
                      </div>
                      <div className="ml-auto">
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-5 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50">
                        {['Mon', 'Tue', 'Wed', 'Thu', 'Fri'].map((day, i) => (
                          <div key={i} className="text-center py-2 text-xs font-medium text-gray-600 dark:text-gray-400 uppercase tracking-wider">
                            {day}
                          </div>
                        ))}
                      </div>
                          ...
                          return (
                            ...
                            >
                              ...
                              <div className="flex items-center justify-between mb-3 pb-2 border-b border-gray-100 dark:border-gray-800">
                                ...
                                {jobs.length > 0 && (
                                  <div className="flex items-center rounded-full bg-primary-100 dark:bg-primary-900/30 border border-primary-200 dark:border-primary-800/50 px-2 py-0.5 shadow-sm">
                              ...
                              {/* Jobs for this day */}
                              <div className="max-h-[200px] overflow-y-auto space-y-2 pr-0.5 scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-600">
                                {jobs.length === 0 ? (
                                  ...
                                  <div className="space-y-2">
                                    {jobs.map((job, idx) => {
                                      ...
                                      // Apply subtle rotation to create a "stacked" effect when multiple cards
                                      const rotationClass = jobs.length > 1 
                                        ? idx === 0 
                                      ...
                                      return (
                                        <div 
                                          key={job.id || idx} 
                                          className={`relative group p-2.5 rounded-lg border ${storeStyle.cardBorder} bg-white dark:bg-gray-800 shadow-sm hover:shadow-md transition-all duration-300 cursor-pointer ${
                                            hasDispenserData ? 'hover:border-primary-400 dark:hover:border-primary-500' : ''
                                          } ${rotationClass}`}
                                          onClick={() => hasDispenserData && handleViewDispenserData(job, new MouseEvent('click') as any)}
                                        >
                                          {/* Favorite icon positioned better */}
                                          {isFavorite && (
                                            <div className="absolute top-1 right-1">
                                              <FiStar className="h-3.5 w-3.5 text-amber-500 fill-current" />
                                            </div>
                                          )}
                                          ...
                                          <div className="flex flex-col">
                                            <div className="flex items-center gap-1.5 mb-1.5">
                                              <span className={`w-2.5 h-2.5 rounded-full ${storeStyle.dot}`}></span>
                                              <h4 className="text-xs font-medium text-gray-900 dark:text-white truncate max-w-[120px]">
                                                {job.customer?.name || 'Unknown'}
                                              </h4>
                                            </div>
                                            
                                            {job.customer?.storeNumber && (
                                              <div className="text-[10px] text-gray-500 dark:text-gray-400 mb-1.5 ml-0.5">
                                            ...
                                            <div className="flex items-center justify-between mt-0.5">
                                              {hasDispenserData && (
                                                <div className="flex items-center text-[10px] bg-gray-50 dark:bg-gray-700/50 rounded-md px-1.5 py-0.5">
                                                  <div className="flex items-center justify-center w-3.5 h-3.5 rounded-full bg-primary-50 dark:bg-primary-900/30 mr-1">
                                                    <GiGasPump className={`h-2 w-2 ${storeStyle.text}`} />
                                                  </div>
                                                  <span className="text-gray-600 dark:text-gray-300">{job.dispensers?.length || 0}</span>
                                                </div>
                                              )}
                                          ...
                                          {/* View indicator for cards with dispenser data */}
                                          {hasDispenserData && (
                                            <div className="absolute bottom-1 right-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                              <div className="flex items-center justify-center h-4 w-4 rounded-full bg-primary-100 dark:bg-primary-900/30">
                                                <FiEye className="h-2.5 w-2.5 text-primary-600 dark:text-primary-400" />
                                              </div>
                                            </div>
                                          )}
                                        </div>
                                    ...
                                    {jobs.length > 4 && (
                                      <div className="flex justify-center">
                                        <span className="text-xs font-medium py-1 px-3 rounded-full bg-primary-50 dark:bg-primary-900/30 text-primary-600 dark:text-primary-400 border border-primary-100 dark:border-primary-800/30">
                  ...
                  {groupedWorkOrders.nextWeek.length > 0 && (
                    <div className="bg-white dark:bg-gray-800 rounded-lg overflow-hidden shadow-md border border-gray-200 dark:border-gray-700 animate-fadeIn">
                      {/* Week header */}
                      <div className="bg-accent-green-50 dark:bg-accent-green-900/20 p-3 border-b border-gray-200 dark:border-gray-700 flex items-center">
                        <div className="h-10 w-10 rounded-full bg-accent-green-100 dark:bg-accent-green-900/40 flex items-center justify-center mr-3 shadow-sm">
                          <FiTrendingUp className="text-accent-green-600 dark:text-accent-green-400" />
                        </div>
                        <div>
                          <h2 className="font-semibold text-gray-800 dark:text-white">Next Week</h2>
                          <p className="text-sm text-gray-600 dark:text-gray-400">
                            {formatDateRange(
                              workWeekDates.nextWeekStart,
                              workWeekDates.nextWeekEnd
                            )}
                          </p>
                        </div>
                        <div className="ml-auto">
                          ...
                          {Array.from({ length: 5 }).map((_, dayIndex) => {
                            ...
                            return (
                              ...
                              >
                                {/* Day header */}
                                <div className="flex items-center justify-between mb-3 pb-2 border-b border-gray-100 dark:border-gray-800">
                                  <span className="inline-flex items-center justify-center h-8 w-8 rounded-full font-medium text-sm text-gray-700 dark:text-gray-300">
                                    {currentDate.getDate()}
                                  </span>
                                  {jobs.length > 0 && (
                                    <div className="flex items-center rounded-full bg-accent-green-100 dark:bg-accent-green-900/30 border border-accent-green-200 dark:border-accent-green-800/50 px-2 py-0.5 shadow-sm">
                                ...
                                <div className="max-h-[200px] overflow-y-auto space-y-2 pr-0.5 scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-600">
                                  {jobs.length === 0 ? (
                                    ...
                                    <div className="space-y-2">
                                      {jobs.map((job, idx) => {
                                        ...
                                        return (
                                          <div 
                                            key={job.id || idx} 
                                            className={`relative group p-2.5 rounded-lg border ${storeStyle.cardBorder} bg-white dark:bg-gray-800 shadow-sm hover:shadow-md transition-all duration-300 cursor-pointer ${
                                              hasDispenserData ? 'hover:border-accent-green-400 dark:hover:border-accent-green-500' : ''
                                            } ${rotationClass}`}
                                            onClick={() => hasDispenserData && handleViewDispenserData(job, new MouseEvent('click') as any)}
                                          >
                                            {/* Favorite icon positioned better */}
                                            ...
                                            <div className="flex flex-col">
                                              ...
                                              <div className="flex items-center justify-between mt-0.5">
                                                {hasDispenserData && (
                                                  <div className="flex items-center text-[10px] bg-gray-50 dark:bg-gray-700/50 rounded-md px-1.5 py-0.5">
                                                    <div className="flex items-center justify-center w-3.5 h-3.5 rounded-full bg-accent-green-50 dark:bg-accent-green-900/30 mr-1">
                                                      <GiGasPump className={`h-2 w-2 ${storeStyle.text}`} />
                                                    </div>
                                                    <span className="text-gray-600 dark:text-gray-300">{job.dispensers?.length || 0}</span>
                                                  </div>
                                            ...
                                            {hasDispenserData && (
                                              <div className="absolute bottom-1 right-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                                <div className="flex items-center justify-center h-4 w-4 rounded-full bg-accent-green-100 dark:bg-accent-green-900/30">
                                                  <FiEye className="h-2.5 w-2.5 text-accent-green-600 dark:text-accent-green-400" />
                                                </div>
                                              </div>
                                            )}
                                          </div>
                                      ...
                                      {jobs.length > 4 && (
                                        <div className="flex justify-center">
                                          <span className="text-xs font-medium py-1 px-3 rounded-full bg-accent-green-50 dark:bg-accent-green-900/30 text-accent-green-600 dark:text-accent-green-400 border border-accent-green-100 dark:border-accent-green-800/30">
                                            {jobs.length} total jobs
                                          </span>
                                        </div>
                                      )}
                  ...
                  {groupedWorkOrders.other.length > 0 && (
                    <div className="bg-white dark:bg-gray-800 rounded-lg overflow-hidden shadow-md border border-gray-200 dark:border-gray-700 mt-6 animate-fadeIn">
                      <div className="bg-secondary-50 dark:bg-secondary-900/20 p-3 border-b border-gray-200 dark:border-gray-700 flex items-center">
                        <div className="h-10 w-10 rounded-full bg-secondary-100 dark:bg-secondary-900/40 flex items-center justify-center mr-3 shadow-sm">
                          <FiList className="text-secondary-600 dark:text-secondary-400" />
                        </div>
                        <div>
                          <h2 className="font-semibold text-gray-800 dark:text-white">Other Dates</h2>
                          <p className="text-sm text-gray-600 dark:text-gray-400">
                            Jobs scheduled outside current and next week
                          </p>
                        </div>
                      ...
                      <div className="p-4">
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2">
                          {groupedWorkOrders.other.map((job, idx) => {
                            const storeType = getStoreTypeForFiltering(job);
                            const storeStyle = getStoreStyles(storeType);
                            const isFavorite = favorites.includes(job.id.toString());
                            const hasDispenserData = job.dispensers && job.dispensers.length > 0;
                            
                            // Get job date for display
                            const jobDate = job.visits?.nextVisit?.date || job.nextVisitDate || job.visitDate || job.date;
                            const formattedDate = jobDate ? new Date(jobDate).toLocaleDateString(undefined, {
                              month: 'short',
                              day: 'numeric',
                              year: 'numeric'
                            }) : 'No date';
                            ...
                            return (
                              <div 
                                key={job.id || idx} 
                                className={`p-3 rounded-lg border ${storeStyle.cardBorder} bg-white dark:bg-gray-800 hover:shadow-md transition-all duration-200 cursor-pointer ${
                                  hasDispenserData ? 'hover:border-secondary-400 dark:hover:border-secondary-500' : ''
                                }`}
                                onClick={() => hasDispenserData && handleViewDispenserData(job, new MouseEvent('click') as any)}
                              >
                                <div className="flex items-center justify-between mb-2">
                                  ...
                                  {isFavorite && (
                                    <FiStar className="h-3.5 w-3.5 text-amber-500 fill-current flex-shrink-0" />
                                  )}
                                </div>
                                
                                <div className="flex items-center text-[10px] text-gray-500 dark:text-gray-400 mb-2">
                                ...
                                <div className="flex items-center justify-between">
                                  {hasDispenserData && (
                                    <div className="flex items-center text-[10px] text-gray-500 dark:text-gray-400">
                                      <div className="flex items-center justify-center w-3.5 h-3.5 rounded-full bg-secondary-50 dark:bg-secondary-900/30 mr-1">
                                        <GiGasPump className={`h-2 w-2 ${storeStyle.text}`} />
                                      </div>
