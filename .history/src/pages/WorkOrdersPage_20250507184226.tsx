    ...
    <div className="h-full max-w-full overflow-x-hidden animate-fadeIn px-4 py-6">
      ...
      {stats && !loading && !error && (
        <div className="mb-6 animate-fadeIn">
          {/* Store Locations Card - Single full-width card */}
            ...
            <div className="p-4">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3">
                {stats.allStores.map((store, index) => (
                  <div key={index} className="flex items-center justify-between p-2.5 rounded-md bg-gray-50 dark:bg-gray-700/50 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
      ...
      {loading ? (
        ...
        <div className="text-center py-12 px-6 text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-gray-800/50 rounded-xl shadow-md border border-gray-200 dark:border-gray-700">
          <FiInfo className="h-12 w-12 mx-auto mb-3 opacity-30" />
          <p className="text-lg font-medium">No work orders found</p>
          <p className="text-sm mt-2 max-w-md mx-auto">Try refreshing or check back later</p>
          <button 
            onClick={fetchWorkOrders}
            className="mt-4 px-4 py-2 bg-primary-500 hover:bg-primary-600 text-white rounded-md text-sm font-medium transition-colors shadow-sm"
          >
          ...
          <div className="xl:col-span-1">
            {selectedWorkOrder ? (
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden sticky top-6">
                {/* Header */}
                <div className="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-750 p-5 border-b border-gray-200 dark:border-gray-700">
                  <div className="flex items-center justify-between">
