  ...
  const renderJobRow = (order: WorkOrder, dateGroupClass?: string) => {
    ...
    return (
      ...
      >
        ...
        {/* Action Buttons Footer - Optimized hybrid design with main buttons and slide-out menu */}
        <div className="p-2 border-t border-gray-700/50 flex items-center gap-2 relative">
          {/* Left side primary action buttons (most commonly used) */}
          <div className="flex gap-2 flex-1 flex-wrap">
            ...
            <button
              ...
              className="flex items-center gap-1 px-3 py-1.5 bg-blue-600 hover:bg-blue-700 text-white rounded transition-colors shadow-sm"
              title="Open in WorkFossa"
            >
              <FiExternalLink className="h-4 w-4" />
              <span className="text-sm font-medium">WorkFossa</span>
            </button>
            ...
            <button
              ...
              className="flex items-center gap-1 px-3 py-1.5 bg-teal-600 hover:bg-teal-700 text-white rounded transition-colors shadow-sm"
            ...
            {/* More Actions Button - Shows slide-out menu */}
            <div className="group relative">
              <button 
                className="flex items-center gap-1 px-3 py-1.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded transition-colors shadow-sm"
              ...
              <div className="absolute top-full left-0 mt-1 z-20 bg-gray-800/95 backdrop-blur-md rounded-md shadow-xl py-2 px-2
                           transition-all duration-200 ease-in-out origin-top-left border border-gray-700/50
                           scale-y-0 opacity-0 group-hover:scale-y-100 group-hover:opacity-100 overflow-hidden">
                <div className="flex flex-col gap-1.5 min-w-[150px]">
                  {/* Rescrape Button */}
                  <button 
                    onClick={(e) => handleForceRescrapeDispenserData(order.id, e)}
                    className="flex items-center gap-2 px-3 py-1.5 bg-cyan-600 hover:bg-cyan-700 text-white rounded transition-colors"
                    title="Force Rescrape Dispenser Data"
                  >
                    <FiRefreshCw className="h-4 w-4" />
                    <span className="text-sm font-medium">Rescrape</span>
                  </button>
                  ...
                  <button 
                    onClick={(e) => {
                      ...
                      addToast('success', 'Copied order ID to clipboard');
                    }}
          ...
          {/* Right side icon buttons - Most important actions */}
          <div className="flex gap-1.5">
            ...
            <button
              ...
              className="p-1.5 bg-amber-500 hover:bg-amber-600 text-white rounded shadow-sm transition-colors"
            ...
            <button
              ...
              className="p-1.5 bg-purple-500 hover:bg-purple-600 text-white rounded shadow-sm transition-colors"
