    ...
    <div className="h-full">
      ...
      <div className="bg-gradient-to-r from-gray-800 to-gray-900 dark:from-gray-900 dark:to-gray-950 text-white rounded-xl shadow-lg mb-6 flex flex-col overflow-hidden border border-gray-700 dark:border-gray-800">
        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-700/60 dark:border-gray-800/60">
          <div className="flex items-center gap-3 relative z-10"> {/* Increased gap */}
            <button
              className={`px-4 py-2.5 rounded-md flex items-center gap-2 transition-all ${
                activeView === 'weekly'
        ...
        <div className="flex items-center gap-4 p-4 relative"> {/* Adjusted padding */}
          ...
          <div className="flex items-center gap-2 z-10"> {/* Changed to gap for consistent spacing */}
            <button
