                    ...
                    <h3 className="text-lg font-semibold text-gray-800 dark:text-white">
                      {calendarViewType === 'month' 
                        ...
                        : `Week of ${new Date(
                            currentYear, 
                            currentMonth, 
                            new Date(currentYear, currentMonth, 1).getDate() + Math.floor((new Date().getDate() - 1) / 7) * 7
                        ...
                        for (let i = 1; i <= daysInMonth; i++) {
                          ...
                          days.push(
                            ...
                            >
                              ...
                              <div className="mt-1 space-y-1 overflow-y-auto" style={{ maxHeight: "100px" }}>
                  ...
                  <div className="p-4">
                    <div className="grid grid-cols-7 gap-1">
                      {(() => {
                        ...
                        const diff = currentDate.getDate() - dayOfWeek + (dayOfWeek === 0 ? 0 : 0);
                        const weekStart = new Date(currentDate);
                        weekStart.setDate(diff);
                        
                        // Create the week header and day cells
                        for (let i = 0; i < 7; i++) {
                                        ...
                                        >
                                          ...
                                          {order.services && order.services.length > 0 && (
                                            <div className="mt-1 text-xs flex items-center gap-1">
                                              ...
                                              <span>{order.services.length} service(s)</span>
                                            </div>
                                          )}
                                          {order.dispensers && order.dispensers.length > 0 && (
                                            <div className="mt-1 text-xs flex items-center gap-1">
