      ...
      >
        ...
        <div className="p-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-3">
            {hasNextVisit && (
              <div className="flex items-start">
                <div className="flex-shrink-0 mt-0.5 mr-2">
                  <div className={`p-1.5 rounded-full ${storeStyle.dot}`}> {/* Used storeStyle.dot for background, adjusted padding */}
                    <FiCalendar className="h-3 w-3 text-white" /> {/* Icon to white, adjusted size */}
                  </div>
                </div>
                <div>
            ...
            {dispenserQty > 0 && (
              <div className="flex items-start"> 
                <div className={`flex-shrink-0 mt-0.5 mr-2 p-1.5 rounded-full ${storeStyle.dot}`}> {/* Used storeStyle.dot for background, adjusted padding */}
                  <GiGasPump className="h-4 w-4 text-white" /> {/* Icon to white */}
                </div>
                <div>
          ...
          <div className="mt-3 flex flex-wrap items-center justify-between border-t border-gray-200 dark:border-gray-700 pt-3">
            <div className="flex items-center">
              <div className={`p-1.5 rounded-full mr-1.5 ${storeStyle.dot}`}> {/* Used storeStyle.dot for background, adjusted padding */}
                 <FiFileText className="h-3 w-3 text-white" /> {/* Icon to white, adjusted size */}
              </div>
