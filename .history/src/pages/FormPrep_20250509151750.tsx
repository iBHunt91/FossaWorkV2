                            ...
                            {formJobs.map((job, index) => {
                              ...
                              return (
                                ...
                                <td className="px-4 py-3">
                                  ...
                                  {/* Display job.message in Progress column for error jobs */}
                                  {job.status === 'error' && job.message && (
                                    <div className="flex items-center text-xs text-red-600 dark:text-red-500 h-full py-1"> {/* Adjusted padding/height for consistency */}
                                      <svg className="w-4 h-4 mr-1.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
                                      </svg>
                                      <span className="font-medium">
                                        {job.message} {/* Display the actual error message */}
                                      </span>
                                    </div>
                                  )}
                                </td>
