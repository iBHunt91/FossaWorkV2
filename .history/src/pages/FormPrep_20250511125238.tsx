...
const FormPrep: React.FC<{}> = () => {
  ...
  const handleClearSingleHistory = () => {
    if (window.confirm('Are you sure you want to clear all single visit job history?')) {
      setFormJobs([]);
  ...
  const handleClearBatchHistory = () => {
    if (window.confirm('Are you sure you want to clear all batch visit job history?')) {
      setBatchJobs([]);
                                          ...
                                          <div className="flex items-center gap-1.5">
                                            ...
                                            <span className="font-medium truncate">
                                              {job.currentVisitName ? 
                                                <>Visit #{(job.completedVisits || 0) + 1}/{job.totalVisits || 0}: {job.currentVisitName}</> : 
