                    ...
                    {Object.entries(instancesByVisit).map(([visitId, visitInstances], i) => {
                      ...
                      return (
                        <li key={`${groupKey}-${visitId}-${i}`} className="text-xs text-gray-600 dark:text-gray-400">
                          ...
                          {/* Optionally show count per visit if needed, but likely not required now 
                          {visitInstances.length > 1 && (
                            <span className="text-gray-400 ml-2">({visitInstances.length} warnings)</span>
                          )} */} 
                        </li>
                      );
                    })}
