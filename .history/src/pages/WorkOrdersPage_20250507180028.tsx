    ...
    <div className="h-full max-w-full overflow-x-hidden animate-fadeIn px-4 py-6">
      ...
      {stats && !loading && !error && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6 animate-fadeIn">
          {/* Work Order Stats Card - Simplified */}
            ...
            <div className="p-4">
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p className="text-3xl font-bold text-gray-900 dark:text-white mt-1">{workOrders.length}</p>
                </div>
                <div className="h-16 w-16 bg-primary-50 dark:bg-primary-900/20 rounded-full flex items-center justify-center">
                  <FiArchive className="text-primary-500 h-8 w-8" />
                </div>
              </div>
              
              <div className="grid grid-cols-2 gap-4">
                <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-3">
                  <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Service Items</p>
                  <p className="text-xl font-semibold text-gray-900 dark:text-white">
                    {stats.totalServices}
                  </p>
                </div>
                <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-3">
                  <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Unique Stores</p>
                  <p className="text-xl font-semibold text-gray-900 dark:text-white">
                    {Object.keys(stats.stores).length}
                  </p>
                </div>
              </div>
            </div>
          ...
          {/* Stores Card - Shows all stores with improved styling */}
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md border border-gray-200 dark:border-gray-700 overflow-hidden">
            <div className="border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700/50 px-4 py-3">
              <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300 flex items-center">
            ...
            <div className="p-4">
              <p className="text-xs text-gray-500 dark:text-gray-400 mb-3">
                {workOrders.length} work orders across {Object.keys(stats.stores).length} locations
              </p>
