    ...
    <div className="h-full max-w-full overflow-x-hidden animate-fadeIn px-4 py-6">
      ...
      {stats && !loading && !error && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6 animate-fadeIn">
          {/* Status Overview Card - Replacing Work Order Stats Card */}
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md border border-gray-200 dark:border-gray-700 overflow-hidden">
            ...
            <div className="p-4">
              <div className="grid grid-cols-3 gap-4">
                <div className="p-3 bg-accent-red-50 dark:bg-accent-red-900/20 border border-accent-red-100 dark:border-accent-red-800/30 rounded-lg flex flex-col items-center">
                  <div className="w-10 h-10 rounded-full bg-accent-red-100 dark:bg-accent-red-900/30 flex items-center justify-center mb-2">
                    <FiAlertCircle className="text-accent-red-500 dark:text-accent-red-400 h-5 w-5" />
                  </div>
                  <p className="text-xs text-accent-red-700 dark:text-accent-red-300 mb-1">Due Now</p>
                  <p className="text-xl font-bold text-accent-red-700 dark:text-accent-red-300">{stats.dueNow}</p>
                </div>
                
                <div className="p-3 bg-accent-amber-50 dark:bg-accent-amber-900/20 border border-accent-amber-100 dark:border-accent-amber-800/30 rounded-lg flex flex-col items-center">
                  <div className="w-10 h-10 rounded-full bg-accent-amber-100 dark:bg-accent-amber-900/30 flex items-center justify-center mb-2">
                    <FiClock className="text-accent-amber-500 dark:text-accent-amber-400 h-5 w-5" />
                  </div>
                  <p className="text-xs text-accent-amber-700 dark:text-accent-amber-300 mb-1">Due Soon</p>
                  <p className="text-xl font-bold text-accent-amber-700 dark:text-accent-amber-300">{stats.dueSoon}</p>
                </div>
                
                <div className="p-3 bg-accent-green-50 dark:bg-accent-green-900/20 border border-accent-green-100 dark:border-accent-green-800/30 rounded-lg flex flex-col items-center">
                  <div className="w-10 h-10 rounded-full bg-accent-green-100 dark:bg-accent-green-900/30 flex items-center justify-center mb-2">
                    <FiCheckCircle className="text-accent-green-500 dark:text-accent-green-400 h-5 w-5" />
                  </div>
                  <p className="text-xs text-accent-green-700 dark:text-accent-green-300 mb-1">Scheduled</p>
                  <p className="text-xl font-bold text-accent-green-700 dark:text-accent-green-300">{stats.scheduled}</p>
                </div>
              </div>
              ...
              <div className="mt-4">
                <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2.5 overflow-hidden">
                  <div className="flex h-full">
                    <div 
                      className="bg-accent-red-500 h-2.5" 
                      style={{ width: `${stats.dueNow / workOrders.length * 100}%` }}
                    ></div>
                    <div 
                      className="bg-accent-amber-500 h-2.5" 
                      style={{ width: `${stats.dueSoon / workOrders.length * 100}%` }}
                    ></div>
                    <div 
                      className="bg-accent-green-500 h-2.5" 
                      style={{ width: `${stats.scheduled / workOrders.length * 100}%` }}
                    ></div>
                  </div>
                </div>
              </div>
          ...
          {/* Stores Card - Updated to include total work order count */}
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md border border-gray-200 dark:border-gray-700 overflow-hidden">
            <div className="border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700/50 px-4 py-3">
              <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300 flex items-center">
