            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex items-center justify-center gap-1 px-1.5">
                <button
                  ...
                  className="tooltip-wrapper p-1.5 bg-teal-600 hover:bg-teal-700 text-white rounded transition-all hover:shadow-md hover:scale-105"
                  aria-label="View Dispenser Data"
                >
                  <GiGasPump className="h-4 w-4" />
                  <span className="tooltip">Dispenser Data</span>
                </button>
                <button
                  onClick={(e) => {
                    e.stopPropagation();
                  ...
                  className="tooltip-wrapper p-1.5 bg-cyan-600 hover:bg-cyan-700 text-white rounded transition-all hover:shadow-md hover:scale-105"
                  aria-label="View Filter Needs"
                >
                  <FiFilter className="h-4 w-4" />
                  <span className="tooltip">Filter Needs</span>
                </button>
              </div>
