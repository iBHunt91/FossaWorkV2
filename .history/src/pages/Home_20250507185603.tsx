...
const HomeContent: React.FC = () => {
    ...
    return (
      <div className="mb-6 animate-fadeIn">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-6">
          {/* Overview card - streamlined with less redundant information */}
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-5 border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-all duration-300 overflow-hidden relative">
            ...
            <h2 className="text-xl font-semibold text-gray-800 dark:text-white mb-4 flex items-center gap-2">
              <FiPieChart className="text-primary-600 dark:text-primary-400" /> Dashboard
            </h2>
            <div className="grid grid-cols-3 gap-3 z-10 relative">
              <div className="bg-blue-50 dark:bg-blue-900/30 rounded-lg p-3 flex flex-col justify-center">
                <span className="text-sm text-gray-500 dark:text-gray-400">Current Week</span>
                <div className="font-semibold text-2xl text-blue-600 dark:text-blue-400">{currentDistribution.current}</div>
              </div>
              
              <div className="bg-green-50 dark:bg-green-900/30 rounded-lg p-3 flex flex-col justify-center">
                <span className="text-sm text-gray-500 dark:text-gray-400">Next Week</span>
                <div className="font-semibold text-2xl text-green-600 dark:text-green-400">{currentDistribution.next}</div>
              </div>
              
              <div className="bg-purple-50 dark:bg-purple-900/30 rounded-lg p-3 flex flex-col justify-center">
                <span className="text-sm text-gray-500 dark:text-gray-400">Total</span>
                <div className="font-semibold text-2xl text-purple-600 dark:text-purple-400">{filteredWorkOrders.length}</div>
              </div>
            </div>
          </div>

          {/* Store distribution - improved layout */}
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-5 border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-all duration-300">
            <h2 className="text-xl font-semibold text-gray-800 dark:text-white mb-4 flex items-center gap-2">
              <FiBarChart2 className="text-primary-600 dark:text-primary-400" /> Locations
            </h2>
            
            <div className="grid grid-cols-2 gap-3">
              {Object.keys(storeDistribution.currentWeek).map(storeType => {
                const color = getStoreColor(storeType);
                return (
                  <div 
                    key={storeType}
                    className={`flex items-center p-2 rounded-lg ${color.border} ${color.dark} border bg-white dark:bg-gray-700`}
                  >
                    <div className={`flex-shrink-0 w-8 h-8 ${color.bg} bg-opacity-20 dark:bg-opacity-30 rounded-full flex items-center justify-center mr-2`}>
                      <span className="text-lg">{color.icon}</span>
                    </div>
                    <div className="flex-1 min-w-0">
                      <p className={`font-medium ${color.text} capitalize truncate`}>
                        {storeType.replace('-', ' ')}
                      </p>
                      <div className="w-full bg-gray-200 dark:bg-gray-600 h-1.5 rounded-full overflow-hidden mt-1">
                        <div 
                          className={`${color.bg} h-1.5`} 
                          style={{ 
                            width: `${(storeDistribution.currentWeek[storeType] / workOrders.length) * 100}%` 
                          }}
                        ></div>
                      </div>
                      <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                        {storeDistribution.currentWeek[storeType]} locations
                      </p>
                    </div>
                  </div>
                );
          ...
          {/* Date range - simplified layout */}
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-5 border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-all duration-300">
            <h2 className="text-xl font-semibold text-gray-800 dark:text-white mb-4 flex items-center gap-2">
              <FiCalendar className="text-primary-600 dark:text-primary-400" /> Schedule
            </h2>
            
            <div className="grid grid-cols-1 gap-3">
              <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-3">
                <div className="flex justify-between items-center mb-1">
                  <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Current Week</span>
                  <span className="bg-blue-100 dark:bg-blue-900/50 text-blue-800 dark:text-blue-300 text-xs px-2 py-0.5 rounded">
                    {currentDistribution.current} jobs
                  </span>
                </div>
              ...
              <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-3">
                <div className="flex justify-between items-center mb-1">
                  <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Next Week</span>
                  <span className="bg-green-100 dark:bg-green-900/50 text-green-800 dark:text-green-300 text-xs px-2 py-0.5 rounded">
                    {currentDistribution.next} jobs
                  </span>
                </div>
                <span className="text-sm text-gray-600 dark:text-gray-400">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg border border-gray-200 dark:border-gray-700">
              <div className="flex items-center">
                <div className="flex-shrink-0 w-10 h-10 bg-blue-50 dark:bg-blue-900/30 rounded-lg flex items-center justify-center mr-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400">
                    {isWorkOrderScraping ? workOrderStatus.message : (
                      workOrderStatus.status === 'completed' ? 
                      `Last update at ${new Date(Date.now()).toLocaleTimeString()}` : 
                      'Initiate work order scrape to update data'
                    )}
                  </p>
                </div>
              </div>
              ...
              <div>
                <button
                  ...
                  className={`px-3 py-1.5 rounded-lg text-sm font-medium flex items-center space-x-1
                    ${isWorkOrderScraping ? 'bg-gray-100 dark:bg-gray-700 text-gray-400 dark:text-gray-500 cursor-not-allowed' : 
            ...
            <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg border border-gray-200 dark:border-gray-700">
              <div className="flex items-center">
                <div className="flex-shrink-0 w-10 h-10 bg-amber-50 dark:bg-amber-900/30 rounded-lg flex items-center justify-center mr-3">
                  <GiGasPump className="text-amber-600 dark:text-amber-400" />
                </div>
                <div className="flex-1">
                  <div className="flex items-center mb-1">
                    {isDispenserScraping ? (
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400">
                    {isDispenserScraping ? dispenserStatus.message : (
                      dispenserStatus.status === 'completed' ?
                      `Last update at ${new Date(Date.now()).toLocaleTimeString()}` :
                      'Initiate dispenser scrape to update data'
                    )}
                  </p>
                </div>
              </div>
              ...
              <div>
                <button
                  ...
                  className={`px-3 py-1.5 rounded-lg text-sm font-medium flex items-center space-x-1
                    ${isDispenserScraping ? 'bg-gray-100 dark:bg-gray-700 text-gray-400 dark:text-gray-500 cursor-not-allowed' : 
  ...
  const renderJobRow = (order: any, dateGroupClass?: string) => {
    const getDispenserQuantity = (order: any) => {
      ...
      return services.filter((s: any) => s.type.toLowerCase().includes('dispenser') || s.type.toLowerCase().includes('meter')).reduce((total: number, s: any) => total + s.quantity, 0);
    };

    const getDisplayName = (order: any) => {
      if (!order || !order.customer) return 'Unknown Customer';
      
      const name = order.customer.name || 'Unknown Customer';
      const storeNumber = order.customer.storeNumber ? `#${order.customer.storeNumber}` : '';
      
      // If the name is long, truncate it for display
      const displayName = name.length > 25 ? `${name.substring(0, 25)}...` : name;
      
      return storeNumber ? `${displayName} ${storeNumber}` : displayName;
    };

    // Extract key information from the order
    const nextVisitDate = order.visits?.nextVisit?.date || order.nextVisitDate || order.visitDate || order.date || 'No date';
    const nextVisitTime = order.visits?.nextVisit?.time || 'No time';
    const location = order.customer?.address?.street || 'No address';
    const cityState = order.customer?.address?.cityState || '';
    const dispensers = getDispenserQuantity(order);
    const totalServices = (order.services || []).reduce((total: number, s: any) => total + s.quantity, 0);
    const isFavorite = favorites.includes(order.id);
    const displayName = getDisplayName(order);
    const storeType = getStoreTypeForFiltering(order);
    const storeStyles = getStoreStyles(storeType);
    const visitId = extractVisitId(order);
    const visitNumber = extractVisitNumber(order);
    const dispenserData = order.dispensers && order.dispensers.length > 0;
    
    // Determine if there are currently dispensers being scraped
    const isBeingScraped = reScrapeDispenserId === order.id;
    
    return (
      <div 
        className={`group bg-white dark:bg-gray-800 rounded-xl shadow-sm hover:shadow-md border-l-4 ${storeStyles.border} border-t border-r border-b border-gray-200 dark:border-gray-700 overflow-hidden mb-3 transition-all duration-200 relative ${dateGroupClass || ''}`}
        onClick={() => handleOrderClick(order)}
      >
        {/* Top gradient decoration */}
        <div className={`absolute top-0 left-0 w-full h-1 ${storeStyles.gradientBg}`}></div>
        
        <div className="flex flex-col sm:flex-row sm:items-center p-3 gap-3">
          {/* Left Section - Basic Info */}
          <div className="flex-grow flex items-start gap-3">
            {/* Store icon */}
            <div className={`flex-shrink-0 w-9 h-9 rounded-full ${storeStyles.lightBg} flex items-center justify-center`}>
              <span className="text-lg">{storeStyles.icon}</span>
            </div>
            ...
            <div className="flex-grow min-w-0">
              <div className="flex items-center justify-between mb-1">
                <div className="flex items-center gap-1.5">
                  ...
                  {order.visits?.nextVisit?.visitNumber && (
                    <span className="text-xs font-medium text-primary-600 dark:text-primary-400 bg-primary-50 dark:bg-primary-900/20 px-1.5 py-0.5 rounded">
                      Visit #{order.visits.nextVisit.visitNumber}
                    </span>
                  )}
                </div>
                ...
                <div className="flex items-center">
                  {nextVisitDate && (
                    <div className={`flex items-center text-xs ${
                      new Date(nextVisitDate) <= new Date() 
                        ? 'text-red-600 dark:text-red-400' 
                        : 'text-gray-600 dark:text-gray-400'
                    }`}>
                      <FiCalendar className="h-3 w-3 mr-1" />
                      <span>{nextVisitDate}</span>
                      {nextVisitTime && <span className="ml-1 text-gray-500 dark:text-gray-500">{nextVisitTime}</span>}
                    </div>
                  )}
                </div>
              </div>
              ...
              <div className="flex items-center text-xs text-gray-500 dark:text-gray-400 gap-4">
                <div className="flex items-center">
                  <FiMapPin className="h-3 w-3 mr-1 text-gray-400 dark:text-gray-500" />
                  <span className="truncate max-w-[250px]">{location}</span>
                  {cityState && <span className="hidden sm:inline ml-1 text-gray-400 dark:text-gray-500">({cityState})</span>}
                </div>
              </div>
            </div>
          </div>
          
          {/* Right Section - Services & Actions */}
          <div className="flex items-center justify-between sm:justify-end gap-4 mt-2 sm:mt-0">
            {/* Service badges */}
            <div className="flex items-center gap-2">
              <div className="flex items-center px-2 py-1 bg-primary-50 dark:bg-primary-900/20 rounded-full">
                <FiTool className="h-3 w-3 mr-1 text-primary-600 dark:text-primary-400" />
                <span className="text-xs font-medium text-primary-700 dark:text-primary-300">{totalServices}</span>
              </div>
              
              <div className="flex items-center px-2 py-1 bg-amber-50 dark:bg-amber-900/20 rounded-full">
                <GiGasPump className="h-3 w-3 mr-1 text-amber-600 dark:text-amber-400" />
                <span className="text-xs font-medium text-amber-700 dark:text-amber-300">{dispensers}</span>
              </div>
              
              {dispenserData && (
                <div className="flex items-center px-2 py-1 bg-green-50 dark:bg-green-900/20 rounded-full">
                  <FiDatabase className="h-3 w-3 mr-1 text-green-600 dark:text-green-400" />
                  <span className="text-xs font-medium text-green-700 dark:text-green-300">{order.dispensers?.length || 0}</span>
                </div>
              )}
            </div>
            ...
            <div className="flex items-center gap-1">
              ...
              <button
                className="p-1 text-gray-400 dark:text-gray-500 rounded-full opacity-0 group-hover:opacity-100 hover:text-blue-500 dark:hover:text-blue-400 transition-colors"
              ...
              {dispenserData && (
                <button
                  className="p-1 text-gray-400 dark:text-gray-500 rounded-full opacity-0 group-hover:opacity-100 hover:text-red-500 dark:hover:text-red-400 transition-colors"
                  onClick={(e) => handleClearDispenserData(order.id, e)}
                  disabled={isBeingScraped}
              ...
              >
                {isBeingScraped ? (
                  <FiRefreshCw className="h-4 w-4 animate-spin text-blue-500 dark:text-blue-400" />
                ) : (
            ...
            <div className="flex flex-wrap gap-1.5">
              {order.services.map((service: any, idx: number) => (
                ...
                >
                  ...
                  <span className="truncate max-w-[150px]">{service.type}</span>
                </div>
              ))}
            </div>
          </div>
    ...
    switch (storeType.toLowerCase()) {
      case 'circle-k':
        return {
          ...
          gradientBg: 'bg-gradient-to-r from-red-500/10 to-red-700/5',
      ...
      case '7-eleven':
        return {
          ...
          gradientBg: 'bg-gradient-to-r from-green-500/10 to-green-700/5',
      ...
      case 'wawa':
        return {
          ...
          gradientBg: 'bg-gradient-to-r from-amber-500/10 to-amber-700/5',
      ...
      default:
        return {
          ...
          gradientBg: 'bg-gradient-to-r from-blue-500/10 to-blue-700/5',
    ...
    <div className="h-full max-w-full overflow-x-hidden">
      ...
      <div className="bg-gradient-to-r from-gray-800 to-gray-900 dark:from-gray-900 dark:to-gray-950 text-white rounded-xl shadow-lg mb-6 flex flex-col overflow-hidden border border-gray-700 dark:border-gray-800">
        ...
        <div className="flex flex-wrap items-center justify-between p-4 border-b border-gray-700/60 dark:border-gray-800/60 gap-3">
          <div className="flex items-center gap-2 flex-grow"> {/* View Type Toggle */}
            <div className="flex gap-1.5 p-1 bg-gray-700/40 dark:bg-gray-800/70 rounded-lg">
              <button
            ...
            <button
              ...
              className="p-2 rounded-lg bg-gray-700/40 hover:bg-gray-700/60 dark:bg-gray-800/70 dark:hover:bg-gray-800/90 transition-colors"
          ...
          <div className="relative flex-grow max-w-md">
            ...
            <input
              ...
              className="block w-full pl-10 pr-10 py-2 bg-gray-700/40 dark:bg-gray-800/70 border border-gray-600/50 dark:border-gray-700/50 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent text-sm transition-colors"
            />
            {searchQuery && (
              <button
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative inline-block">
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-2 rounded-lg bg-gray-700/40 hover:bg-gray-700/60 dark:bg-gray-800/70 dark:hover:bg-gray-800/90 transition-colors text-sm font-medium"
              >
                ...
                <FiChevronDown className="h-3.5 w-3.5 ml-1" />
              </button>

              {filterDropdownOpen && (
                <div
                  className="absolute right-0 mt-2 w-48 rounded-md shadow-lg bg-white dark:bg-gray-800 ring-1 ring-black ring-opacity-5 z-50 divide-y divide-gray-200 dark:divide-gray-700"
                ...
                >
                  ...
                  <div className="py-1">
                    ...
                    >
                      <span className="inline-block h-2.5 w-2.5 rounded-full bg-red-500 mr-2"></span>
                      7-Eleven
                    </button>
                    ...
                    >
                      <span className="inline-block h-2.5 w-2.5 rounded-full bg-amber-500 mr-2"></span>
                      Circle K
                    </button>
                    ...
                    >
                      <span className="inline-block h-2.5 w-2.5 rounded-full bg-purple-500 mr-2"></span>
                      Wawa
                    </button>
                    ...
                    >
                      <span className="inline-block h-2.5 w-2.5 rounded-full bg-blue-500 mr-2"></span>
                      Other
                    </button>
                  </div>
                </div>
        ...
        {/* Bottom section - Update status indicators and update buttons */}
        <div className="flex flex-wrap items-center justify-between gap-4 p-4 bg-gray-900/40 dark:bg-black/20">
          <div className="flex items-center gap-4">
            {/* Last updated */}
            <div className="flex items-center gap-2">
              <div className="h-7 w-7 rounded-full bg-gray-700/80 dark:bg-gray-800/80 flex items-center justify-center">
                <FiClock className="h-3.5 w-3.5 text-gray-300" />
              </div>
              <div>
            ...
            <div className="flex items-center gap-2">
              <div className="h-7 w-7 rounded-full bg-gray-700/80 dark:bg-gray-800/80 flex items-center justify-center">
                <FiCalendar className="h-3.5 w-3.5 text-gray-300" />
              </div>
              <div>
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button
              ...
              className={`py-1.5 px-3 rounded-lg text-xs flex items-center gap-1.5 ${
                isWorkOrderScraping || isDispenserScraping
                  ? 'bg-gray-800/50 text-gray-500 cursor-not-allowed'
                  : 'bg-primary-600/90 hover:bg-primary-600 text-white transition-colors'
              }`}
            >
              {isWorkOrderScraping ? (
                <>
            ...
            <button
              ...
              className={`py-1.5 px-3 rounded-lg text-xs flex items-center gap-1.5 ${
                isWorkOrderScraping || isDispenserScraping
                  ? 'bg-gray-800/50 text-gray-500 cursor-not-allowed'
                  : 'bg-amber-600/90 hover:bg-amber-600 text-white transition-colors'
              }`}
            >
              {isDispenserScraping ? (
                <>
                  <FiRefreshCw className="h-3 w-3 animate-spin" />
                  <span>Updating Dispensers...</span>
                </>
              ) : (
                <>
                  <GiGasPump className="h-3 w-3" />
                  <span>Update Dispensers</span>
                </>
              )}
            </button>
          </div>
