              ...
              <div className="relative z-10">
                ...
                <div className="flex items-center space-x-2 relative z-10">
                  <button
                    ...
                    className={`px-4 py-2 rounded-md flex items-center gap-2 transition-colors ${activeTab === 'single'
                  ...
                  <button
                    ...
                    className={`px-4 py-2 rounded-md flex items-center gap-2 transition-colors ${activeTab === 'batch'
                        ? 'bg-blue-600 text-white'
                        : 'bg-[#2d3c55] text-gray-300 hover:bg-[#3a4a66]'
                    }`}
                  >
