  ...
  const extractDispenserProgressLocal = (message: string, totalDispensers?: number): { current: number; total: number } => {
    ...
    if (totalDispensers && totalDispensers > 0) {
      ...
      if (matchDispenser) {
        ...
        // Optionally, we could also update total here if message is considered more authoritative
        // total = parseInt(matchDispenser[2], 10); 
      } else {
      ...
      // If current is still 0 but there's a total, it implies it hasn't started or message is generic.
      // Current will remain 0, total is set.
    } else {
      // Fallback: if totalDispensers is not provided or invalid, try to parse both from message
                                        ...
                                        <div>
                                          ...
                                          return (
                                            <div>
                                              ...
                                              <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-1.5 overflow-hidden">
                                                <div className="h-1.5 bg-gray-300 dark:bg-gray-600 rounded-full animate-pulse-progress-fuel" style={{ width: '100%' }}></div>
                                              </div>
                                            </div>
                                          );
                                        }
