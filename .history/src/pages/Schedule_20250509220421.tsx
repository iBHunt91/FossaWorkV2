...
// Customer type is used within WorkOrder, not directly exported for JobCard needs
type Customer = {
  name: string;
...
// Dispenser type is used within WorkOrder, not directly exported for JobCard needs
...
// --- Helper function to get store type for filtering (Moved to module scope) ---
...
// --- Helper function to extract visit number (Moved to module scope) ---
...
// --- Helper function for store-specific styles (Moved to module scope) ---
export const getStoreStyles = (storeType: string) => {
  const SKELETON_STYLE = {
      ...
      dot: 'bg-gray-400',
      accentBorderClass: 'border-gray-500', // Fallback border
      accentHoverBgClass: 'hover:bg-gray-100 dark:hover:bg-gray-600', // Fallback hover
    };
  switch (storeType.toLowerCase()) {
    case '7-eleven': return { 
      ...
      accentHoverBgClass: 'hover:bg-green-50 dark:hover:bg-green-700/20'
    };
    case 'circle-k': return { 
      ...
      accentHoverBgClass: 'hover:bg-red-50 dark:hover:bg-red-700/20'
    };
    case 'wawa': return { 
      ...SKELETON_STYLE, 
      ...
      accentHoverBgClass: 'hover:bg-purple-50 dark:hover:bg-purple-700/20'
    };
    default: return { 
      ...SKELETON_STYLE, 
      ...
      accentHoverBgClass: 'hover:bg-blue-50 dark:hover:bg-blue-700/20'
    };
  }
};
          ...
          return (
            <div key={section.id} className="py-2">
              ...
              {section.orders.length > 0 ? (
                <div className="p-2 sm:p-4 grid grid-cols-1 gap-0">
                  {visibleOrders.map(order => (
                    <JobCard
                      ...
                      onClearDispenserData={handleClearDispenserData}
                      onForceRescrapeDispenserData={handleForceRescrapeDispenserData}
                      onToggleFavorite={toggleFavorite}
                      isFavorite={favorites[order.id] ?? order.isFavorite ?? false}
                      operationLoading={operationLoading}
                      // className will be handled by JobCard default or specific overrides if needed later
                    />
                  ))}
