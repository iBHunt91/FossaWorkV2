                                  ...
                                  <div className="mt-2 space-y-2.5">
                                    {job.status === 'running' && (
                                      <>
                                        ...
                                        {(() => {
                                          // Extract dispenser information from message
                                          const dispenserInfo = extractDispenserProgress(job.message || '', job.dispenserCount);
                                          if (dispenserInfo.current > 0) {
                                            const progressPercent = Math.round((dispenserInfo.current / Math.max(dispenserInfo.total, 1)) * 100);
                                            return (
                                              <div className="mt-2">
                                        ...
                                        {job.startTime && (
                                          <div className="flex items-center text-xs text-gray-500 dark:text-gray-400 mt-2">
                                            <svg className="w-3 h-3 mr-1 text-primary-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
