                        ...
                        <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                          ...
                          <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            {batchJobs.map((job, index) => {
                              // Temporarily keep existing row structure for subsequent focused edits
                              const currentVisitMessage = job.currentVisitStatus || job.message || '';
                              const dispenserInfo = extractDispenserProgressLocal(currentVisitMessage, job.formsTotal); // Assuming formsTotal is per-visit dispenser count
