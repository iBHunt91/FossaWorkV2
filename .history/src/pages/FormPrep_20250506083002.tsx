  ...
  const updateJobStatus = (status: any) => {
    ...
    if (activeJobIndex !== -1) {
      ...
      updatedJobs[activeJobIndex] = {
        ...
        dispenserCount: jobToUpdate.dispenserCount || dispenserCount || 0
      };
                                      ...
                                      {job.status === 'completed' 
                                        ...
                                        : job.status === 'idle' || job.status === 'running'
                                          ? (() => {
                                              ...
                                              const dispenserPercent = dispenserCurrent > 0 
                                                ? Math.round((dispenserCurrent / (job.dispenserCount || dispenserTotal || 1)) * 100)
                                                : 0;
                                                    ...
                                                    <div className="flex items-center justify-between mb-1">
                                                      ...
                                                      <div className="flex items-center space-x-2">
                                                        <span className="text-xs font-mono bg-gray-100 dark:bg-gray-700 px-1.5 py-0.5 rounded text-gray-700 dark:text-gray-300">
                                                          #{dispenserCurrent}/{dispenserTotal || '?'}
                                                        </span>
