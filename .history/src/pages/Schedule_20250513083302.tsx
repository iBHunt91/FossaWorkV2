        ...
        <div className="flex items-center justify-end p-1.5 border-t border-gray-700/50 relative group">
          ...
          <div className="flex gap-1.5">
            <button
              ...
              className="p-1 bg-blue-500 hover:bg-blue-600 text-white rounded-md transition-colors flex items-center justify-center"
            ...
            <button
              ...
              className="p-1 bg-amber-500 hover:bg-amber-600 text-white rounded-md transition-colors flex items-center justify-center"
            ...
            <button
              className="p-1 bg-indigo-600 hover:bg-indigo-700 text-white rounded-md transition-colors relative z-20 flex items-center gap-1 overflow-hidden"
          ...
          <div className="absolute left-0 top-0 z-10 flex items-center bg-gray-800/95 backdrop-blur-md rounded-r-lg shadow-xl py-2 px-3
            ...
            <div className="flex flex-wrap gap-2 items-center">
              ...
              {/* Dispenser Data Group - Most commonly used */}
              <div className="flex flex-wrap items-center gap-2 pr-2 border-r border-gray-600">
                ...
                <button
                  ...
                  className="flex items-center gap-1 px-2 py-1 bg-purple-600 hover:bg-purple-500 text-white rounded-md transition-colors"
                  title="View Dispenser Data"
                >
                  <GiGasPump className="h-3.5 w-3.5 flex-shrink-0" />
                  <span className="text-xs whitespace-nowrap hidden sm:inline">Dispensers</span>
                </button>
