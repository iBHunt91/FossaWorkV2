                                        ...
                                        : job.status === 'idle' || job.status === 'running'
                                          ? (() => {
                                              ...
                                              if (job.message) {
                                                ...
                                                if (dispenserMatch && dispenserMatch[1]) {
                                                  ...
                                                  if (workOrderId && dispenserDetails[`W-${workOrderId}`]) {
                                                    ...
                                                    if (dispensersData && dispensersData.length >= dispenserCurrent) {
                                                      // Dispenser arrays are 0-indexed, but dispenserCurrent is 1-indexed
                                                      const dispenserData = dispensersData[dispenserCurrent - 1];
                                              ...
                                              const calculatedDispenserPercent = dispenserCurrent > 0 && authoritativeTotalForPercent > 0
                                                ? Math.floor((dispenserCurrent / authoritativeTotalForPercent) * 100)
                                                : 0;
