  ...
  useEffect(() => {
    ...
    const reloadData = async () => {
      ...
      try {
        ...
        // Create enhanced work orders with dispenser data
        // Get a fresh copy of dispenserData from the context instead of using stale closure
        const latestDispenserData = window.dispenseDataRef ? 
          window.dispenseDataRef.current : 
          {};
