                            ...
                            {batchJobs.map((job, index) => {
                              ...
                              >
                                ...
                                <td className="px-4 py-3 whitespace-nowrap">
                                    ...
                                    {job.status === 'running' && (
                                        <div className="mt-1 text-xs text-gray-100 dark:text-gray-100 pt-1 border-t border-gray-200 dark:border-gray-700">
                                          <div className="flex items-center bg-primary-500 dark:bg-primary-600 rounded-md px-2 py-1 text-white gap-1.5 w-full justify-center"> 
                                            <FiRefreshCw className="h-3.5 w-3.5 animate-spin flex-shrink-0 text-white" /> 
