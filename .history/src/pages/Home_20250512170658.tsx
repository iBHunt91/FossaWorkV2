  ...
  const renderMapPanel = () => {
    ...
    const locationsToShow = inRangeOrders
      ...
      .map(order => ({
        ...
        lat: order.coordinates?.latitude || order.location!.latitude,
        lng: order.coordinates?.longitude || order.location!.longitude,
