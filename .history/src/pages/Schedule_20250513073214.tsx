  ...
  const renderJobRow = (order: WorkOrder, dateGroupClass?: string) => {
    ...
    return (
      ...
      >
        ...
        {/* Action Icons Footer - Enhanced Slide Out Menu */}
        <div className="flex items-center justify-end p-1.5 border-t border-gray-700/50 relative group">
          ...
          <div className="flex gap-1.5">
            <button
              ...
              className="p-1.5 bg-blue-500 hover:bg-blue-600 text-white rounded-md shadow-sm transition-all hover:shadow hover:-translate-y-0.5"
            ...
            <button
              ...
              className="p-1.5 bg-amber-500 hover:bg-amber-600 text-white rounded-md shadow-sm transition-all hover:shadow hover:-translate-y-0.5"
            ...
            {/* More Options Button - Toggles the slide-out menu */}
            <button
              className="p-1.5 bg-gray-600 hover:bg-gray-700 text-white rounded-md shadow-sm transition-all hover:shadow relative z-20 overflow-hidden"
              title="More Options"
              aria-label="More Options"
            >
              <div className="absolute inset-0 bg-gradient-to-br from-gray-500 to-transparent opacity-20"></div>
              <FiChevronDown className="h-3.5 w-3.5 transform transition-transform duration-300 group-hover:opacity-0 group-hover:scale-0" />
              <FiChevronUp className="h-3.5 w-3.5 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 transform transition-transform duration-300 scale-0 opacity-0 group-hover:scale-100 group-hover:opacity-100" />
            </button>
          </div>

          {/* Slide-out menu - Enhanced with better transitions and organization */}
          <div className="absolute right-0 top-0 z-10 rounded-lg shadow-xl py-2 px-0.5
                         bg-slate-800/95 backdrop-blur-md border border-gray-700/50
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex items-center justify-center gap-1 px-1.5">
                <button
                  onClick={() => navigate(`/app/form-prep?workOrderId=${order.id}&visitId=${visitNumber}`)}
                  className="relative p-1.5 bg-blue-600 hover:bg-blue-700 text-white rounded transition-all hover:shadow-md hover:scale-105 group/tooltip"
                  aria-label="Go to Form Prep"
                >
                  <FiEdit3 className="h-4 w-4" />
                  <span className="absolute -top-7 left-1/2 -translate-x-1/2 px-1.5 py-0.5 bg-black/80 text-white text-[10px] rounded opacity-0 invisible group-hover/tooltip:opacity-100 group-hover/tooltip:visible transition-opacity whitespace-nowrap">Form Prep</span>
                </button>
                <button
                  onClick={(e) => handleViewInstructions(e, order)}
                  className="relative p-1.5 bg-amber-600 hover:bg-amber-700 text-white rounded transition-all hover:shadow-md hover:scale-105 group/tooltip"
                  aria-label="View Instructions"
                >
                  <FiEye className="h-4 w-4" />
                  <span className="absolute -top-7 left-1/2 -translate-x-1/2 px-1.5 py-0.5 bg-black/80 text-white text-[10px] rounded opacity-0 invisible group-hover/tooltip:opacity-100 group-hover/tooltip:visible transition-opacity whitespace-nowrap">Instructions</span>
                </button>
                <button
                  onClick={(e) => {
                    e.stopPropagation();
                  ...
                  className="relative p-1.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded transition-all hover:shadow-md hover:scale-105 group/tooltip"
                  aria-label="Open in WorkFossa"
                >
                  <FiExternalLink className="h-4 w-4" />
                  <span className="absolute -top-7 left-1/2 -translate-x-1/2 px-1.5 py-0.5 bg-black/80 text-white text-[10px] rounded opacity-0 invisible group-hover/tooltip:opacity-100 group-hover/tooltip:visible transition-opacity whitespace-nowrap">WorkFossa</span>
                </button>
              </div>
              
              {/* Divider */}
              <div className="h-px w-full bg-gray-600/50"></div>
              
              {/* Dispenser Actions Group */}
              <div className="flex items-center justify-center gap-1 px-1.5">
                <button
                  onClick={(e) => handleViewDispenserDataUnified(e, order)}
                  className="relative p-1.5 bg-teal-600 hover:bg-teal-700 text-white rounded transition-all hover:shadow-md hover:scale-105 group/tooltip"
                  aria-label="View Dispenser Data"
                >
                  <GiGasPump className="h-4 w-4" />
                  <span className="absolute -top-7 left-1/2 -translate-x-1/2 px-1.5 py-0.5 bg-black/80 text-white text-[10px] rounded opacity-0 invisible group-hover/tooltip:opacity-100 group-hover/tooltip:visible transition-opacity whitespace-nowrap">Dispenser Data</span>
                </button>
                <button
                  onClick={(e) => {
                    e.stopPropagation();
                  ...
                  className="relative p-1.5 bg-cyan-600 hover:bg-cyan-700 text-white rounded transition-all hover:shadow-md hover:scale-105 group/tooltip"
                  aria-label="View Filter Needs"
                >
                  <FiFilter className="h-4 w-4" />
                  <span className="absolute -top-7 left-1/2 -translate-x-1/2 px-1.5 py-0.5 bg-black/80 text-white text-[10px] rounded opacity-0 invisible group-hover/tooltip:opacity-100 group-hover/tooltip:visible transition-opacity whitespace-nowrap">Filter Needs</span>
                </button>
              </div>
              ...
              <div className="flex items-center justify-center gap-1 px-1.5">
                <button 
                  ...
                  className="relative p-1.5 bg-green-600 hover:bg-green-700 text-white rounded transition-all hover:shadow-md hover:scale-105 group/tooltip"
                  aria-label="Rescrape Dispenser Data"
                >
                  <FiRefreshCw className="h-4 w-4" />
                  <span className="absolute -top-7 left-1/2 -translate-x-1/2 px-1.5 py-0.5 bg-black/80 text-white text-[10px] rounded opacity-0 invisible group-hover/tooltip:opacity-100 group-hover/tooltip:visible transition-opacity whitespace-nowrap">Rescrape</span>
                </button>
                <button 
                  onClick={(e) => handleClearDispenserData(order.id, e)}
                  className="relative p-1.5 bg-red-600 hover:bg-red-700 text-white rounded transition-all hover:shadow-md hover:scale-105 group/tooltip"
                  aria-label="Clear Dispenser Data"
                >
                  <FiTrash2 className="h-4 w-4" />
                  <span className="absolute -top-7 left-1/2 -translate-x-1/2 px-1.5 py-0.5 bg-black/80 text-white text-[10px] rounded opacity-0 invisible group-hover/tooltip:opacity-100 group-hover/tooltip:visible transition-opacity whitespace-nowrap">Clear Data</span>
                </button>
              </div>
            </div>
          </div>
        ...
        {/* Tooltip styles are applied via Tailwind classes */}
      </div>
    );
  };
