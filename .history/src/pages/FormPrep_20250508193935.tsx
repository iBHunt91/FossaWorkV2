                                ...
                                <td className="px-4 py-3">
                                  {job.status === 'running' && (
                                    <div className="space-y-3">
                                      ...
                                      {import.meta.env.DEV && (
                                        <div className="text-xs text-gray-500 dark:text-gray-400">
                                          {job.currentVisitStatus || "No status"}
                                        </div>
                                      )}
                                      ...
                                      {(() => {
                                        ...
                                        // Show empty dispenser bar if we have formsTotal but no dispenser info
                                        if (job.formsTotal && job.formsTotal > 1) {
                                          return (
                                            <div>
                                              <div className="flex justify-between items-center text-xs mb-1">
                                                <div className="font-medium text-amber-600 dark:text-amber-400 flex items-center gap-1">
                                      ...
                                      {(() => {
                                        ...
                                        // If no explicit fuel info but we have some progress, show a default "Regular" fuel type
                                        if (!fuelInfo.type && job.formsCurrent && job.formsTotal) {
                                          return (
                                            <div>
                                              <div className="flex justify-between items-center text-xs mb-1">
                                                <div className="font-medium text-blue-600 dark:text-blue-400 flex items-center gap-1">
                                              ...
                                              <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2 overflow-hidden">
                                                <div 
                                                  className="h-full rounded-full transition-all duration-500 bg-blue-500"
                                                  style={{ width: `${Math.min(Math.round((job.formsCurrent / Math.max(job.formsTotal, 1)) * 100), 100)}%` }}
                                                ></div>
                                              </div>
                                            </div>
                                          );
                                      ...
                                      {/* Fallback when no progress data is available */}
                                      {!job.currentVisitStatus && !job.message && (
                                        <div className="text-center py-2">
                                          <div className="text-xs text-gray-500 dark:text-gray-400">
                                            Waiting for data...
                                          </div>
                                          <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2 mt-1 overflow-hidden">
                                            <div className="h-full rounded-full bg-amber-500 animate-pulse w-1/3"></div>
                                          </div>
                                        </div>
                                      )}
                                    </div>
