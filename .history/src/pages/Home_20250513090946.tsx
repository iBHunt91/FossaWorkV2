...
const HomeContent = () => {
  ...
  const renderMapPanel = () => {
    ...
    const storeGeocodingFallback: Record<string, {lat: number, lng: number}> = {
      // Circle K stores (accurate coordinates for real locations)
      ...
      // Additional Circle K locations
      '126723': { lat: 36.5, lng: 36.5 },
      '126730': { lat: 38.3, lng: -96.2 },
      '126750': { lat: 39.8, lng: -94.7 },
      '126758': { lat: 37.7, lng: -97.3 },
      '126761': { lat: 38.2, lng: -95.3 },
      '126666': { lat: 36.8, lng: -98.2 },
      '126675': { lat: 37.9, lng: -97.1 },
      '126694': { lat: 39.1, lng: -95.8 },
      '126729': { lat: 38.6, lng: -97.4 },
      '126770': { lat: 37.3, lng: -96.7 },
      // 7-Eleven stores
      ...
      // Wawa stores
      '3339': { lat: 39.9526, lng: -75.1652 }, // Philadelphia
      '3929': { lat: 38.9072, lng: -77.0369 }, // Washington DC
      '3848': { lat: 28.5383, lng: -81.3792 }, // Orlando
      '3764': { lat: 27.9506, lng: -82.4572 }, // Tampa
      '3015': { lat: 39.0836, lng: -77.1483 }, // Rockville
    };
      ...
      .map(order => {
          ...
          if (extractedLat === undefined || extractedLng === undefined) {
              ...
              if (fallbackLocation) {
                  ...
                  // Skip creating mock locations as they're inaccurate
                  console.log(`[renderMapPanel] No location data available for order ${order.id}`);
