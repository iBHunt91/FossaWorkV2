  ...
  const renderJobRow = (order: WorkOrder, dateGroupClass?: string) => {
    ...
    return (
      ...
      >
        ...
        {/* Action Buttons Footer - Icon-only buttons with slide-out menu */}
        <div className="p-2 border-t border-gray-700/50 flex items-center justify-between gap-2 relative">
          ...
          <div className="flex gap-1.5">
            ...
            <button
              ...
              className="p-1.5 bg-blue-600 hover:bg-blue-700 text-white rounded shadow-sm transition-colors"
            ...
            <button
              ...
              className="p-1.5 bg-teal-600 hover:bg-teal-700 text-white rounded shadow-sm transition-colors"
            ...
            <div className="group relative">
              <button 
                className="p-1.5 bg-gray-600 hover:bg-gray-700 text-white rounded shadow-sm transition-colors"
                title="More Actions"
              >
              ...
              <div className="absolute top-full right-0 mt-1 z-20 bg-gray-800/95 backdrop-blur-md rounded-md shadow-xl py-2 px-2
                           transition-all duration-200 ease-in-out origin-top-right border border-gray-700/50
                           scale-0 opacity-0 group-hover:scale-100 group-hover:opacity-100 overflow-hidden">
                <div className="flex flex-col gap-1.5 min-w-[150px]">
                  {/* Rescrape Button */}
                  <button 
                    onClick={(e) => handleForceRescrapeDispenserData(order.id, e)}
                    className="flex items-center gap-2 px-3 py-1.5 text-left text-gray-200 hover:bg-gray-700/50 rounded transition-colors"
                    title="Force Rescrape Dispenser Data"
                  >
                    <FiRefreshCw className="h-4 w-4 text-cyan-400" />
                    <span className="text-sm">Rescrape Data</span>
                  </button>
                  ...
                  <button 
                    ...
                    title="Copy Order ID"
                  >
                    <FiCopy className="h-4 w-4 text-blue-400" />
