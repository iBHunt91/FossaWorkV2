      ...
      >
        ...
        <div className="flex items-center justify-end space-x-2 p-2 border-t border-gray-200 dark:border-gray-700">
          <button
            ...
            className="p-1.5 hover:bg-gray-200 dark:hover:bg-gray-700 rounded-md transition-colors text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400"
