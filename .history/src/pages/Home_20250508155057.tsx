...
import { 
  ...
  FiDatabase,
  FiEye,
  FiEyeOff  // Add FiEye and FiEyeOff icons for the toggle button
} from 'react-icons/fi'
...
const HomeContent = () => {
  ...
  // Add a new component for instructions
  const InstructionsSection = React.memo(({ instructions, fullInstructions, storeStyle }: { instructions: string, fullInstructions: string, storeStyle: any }) => {
    ...
    // Default storeStyle if not provided
    const defaultStoreStyle = { cardBg: 'bg-gray-50 dark:bg-gray-700/30', text: 'text-gray-600 dark:text-gray-400' };
    const styleToUse = storeStyle || defaultStoreStyle;

    return (
      <div className={`mt-2 rounded p-3 border ${styleToUse.cardBg} border-gray-200 dark:border-gray-700`}>
        <div className="flex items-start">
          <div className="flex-shrink-0 mt-0.5">
            <FiInfo className={`h-4 w-4 ${styleToUse.text}`} />
          </div>
  ...
  // Update the renderJobRow function as a regular function (not wrapped in useCallback)
        ...
        <div className="p-4">
          ...
          {order.instructions && (
            <InstructionsSection 
              ...
              fullInstructions={order.instructions} 
      ...
      <div className="pb-8 px-4">
        ...
        <div className="mb-8">
          <div className="flex items-center space-x-3 mb-5">
            <div className="flex-shrink-0 h-11 w-11 bg-blue-50 dark:bg-blue-900/30 rounded-full flex items-center justify-center">
              <FiActivity className="text-blue-600 dark:text-blue-400" />
            </div>
            <div>
        ...
        <div className="mb-8">
          <div className="flex items-center space-x-3 mb-5">
            <div className="flex-shrink-0 h-11 w-11 bg-green-50 dark:bg-green-900/30 rounded-full flex items-center justify-center">
              <FiTrendingUp className="text-green-600 dark:text-green-400" />
            </div>
            <div>
              <h2 className="text-lg font-semibold text-gray-900 dark:text-white">
            ...
            <div className="ml-auto">
              <span className="bg-green-100 dark:bg-green-900/50 text-green-800 dark:text-green-300 text-xs font-medium px-3.5 py-1.5 rounded-full">
        ...
        {grouped.other.length > 0 && (
          <div className="mb-8">
            <div className="flex items-center space-x-3 mb-5">
              <div className="flex-shrink-0 h-11 w-11 bg-purple-50 dark:bg-purple-900/30 rounded-full flex items-center justify-center">
                <FiList className="text-purple-600 dark:text-purple-400" />
              </div>
              <div>
                <h2 className="text-lg font-semibold text-gray-900 dark:text-white">
              ...
              <div className="ml-auto">
                <span className="bg-purple-100 dark:bg-purple-900/50 text-purple-800 dark:text-purple-300 text-xs font-medium px-3.5 py-1.5 rounded-full">
                  ...
                  {Array.from({ length: 5 }).map((_, dayIndex) => {
                    ...
                    return (
                      <div key={dayIndex} className={`flex flex-col ${isToday ? 'bg-blue-50 dark:bg-blue-900/10' : ''}`}>
                        {/* Date header */}
                        <div className={`p-4 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between ${isToday ? 'bg-blue-100/50 dark:bg-blue-900/20' : 'bg-gray-50 dark:bg-gray-800'}`}>
                          <div className="flex flex-col">
                          ...
                          {jobs.length > 0 && (
                            <span className={`text-xs px-3 py-1.5 rounded-full ${isToday ? 'bg-blue-200 dark:bg-blue-800 text-blue-800 dark:text-blue-200' : 'bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-300'}`}>
                              {jobs.length}
                            </span>
                          )}
                        </div>
                ...
                <div className="border-t border-gray-200 dark:border-gray-700">
                  <div className="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 p-4 border-b border-gray-200 dark:border-gray-700">
                    <h4 className="font-medium text-gray-700 dark:text-gray-300 flex items-center">
                      ...
                      <span className="ml-2 px-2.5 py-1 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-full text-xs">
                      ...
                      return (
                        <div key={dayIndex} className="flex flex-col">
                          ...
                          <div className="p-4 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between bg-gray-50 dark:bg-gray-800">
                            ...
                            {jobs.length > 0 && (
                              <span className="text-xs px-3 py-1.5 rounded-full bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-300">
                                {jobs.length}
                              </span>
                            )}
                          </div>
