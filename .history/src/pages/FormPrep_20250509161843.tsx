        ...
        setBatchJobs(prevJobs => {
          ...
          if (jobStatusChanged) {
            if (jobToUpdate.status === 'completed') {
              addToast(`Batch job for "${jobToUpdate.filePath}" completed successfully.`, 'success');
            }
            if (jobToUpdate.status === 'error' && jobToUpdate.message !== 'Batch processing stopped by user') {
              addToast(`Batch job for "${jobToUpdate.filePath}" failed: ${jobToUpdate.message}`, 'error');
            }
          }
                                  ...
                                  {job.status === 'running' && (
                                      ...
                                      {(() => {
                                        ...
                                        <div className="flex justify-between items-center text-xs mb-1">
                                                ...
                                                <div className="w-full bg-gray-200 dark:bg-gray-700/60 rounded-full h-1.5"><div className="h-1.5 bg-gray-300 dark:bg-gray-600/70 rounded-full animate-pulse" style={{ width: '100%' }}></div></div>
                                      </div>
                                        );
                                          }
                                            ...
                                            <div>
                                              <div className="flex justify-between items-center text-xs mb-1">
                                                <div className="font-medium text-blue-600 dark:text-blue-400 flex items-center gap-1">
                                                    ...
                                                    {fuelInfo.type} (Current Visit) {/* Display fuel type clearly */}
                                                </div>
                                                <span className="font-mono bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300 px-1.5 py-0.5 rounded">
                                                  {fuelInfo.current}/{fuelInfo.total}
                                                </span>
