  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
        {/* Main Tools section */}
        <div className="lg:col-span-2 bg-white dark:bg-gray-800 rounded-xl shadow-md p-5 border border-gray-100 dark:border-gray-700">
          ...
          {/* Filter Summary Card - New */}
          <div className="lg:col-span-1">
            <FilterSummaryCard currentWeekDate={currentWeekDate} />
          </div>
        </div>
      </div>
    </div>
