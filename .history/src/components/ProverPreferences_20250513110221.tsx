                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    ...
                    >
                      <button
                        ...
                        onClick={() => toggleDropdown(prover.prover_id)}
                      ...
                      {openDropdownId === prover.prover_id && (
                        <div 
                          className={`absolute z-[9999] ${dropdownPositions[prover.prover_id] === 'top' ? 'bottom-full mb-2' : 'top-full mt-2'} bg-gray-700 dark:bg-gray-700 border border-gray-600 dark:border-gray-600 rounded-lg shadow-lg`} 
                          style={{ 
                            width: '220px',
                            maxHeight: '280px',
                            overflow: 'auto',
