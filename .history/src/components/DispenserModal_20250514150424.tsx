              ...
              >
                <div className="bg-blue-500/40 p-1.5 rounded-lg mr-3 shadow-inner">
                  <GiGasPump className="text-white" size={22} />
                                ...
                                <span>Dispenser Data</span>                 {orderId && (                  <span className="ml-2 font-normal text-blue-100 flex items-center bg-blue-700/40 px-2 py-0.5 rounded-md text-sm">                    <FiHash className="mr-1 opacity-80" size={14} />                    <span className="font-semibold">{orderId}</span>                  </span>                )}                {visitNumber && (                  <span className="ml-2 font-normal text-blue-100 flex items-center bg-blue-700/40 px-2 py-0.5 rounded-md text-sm">                    <FiInfo className="mr-1 opacity-80" size={14} />                    <span className="font-semibold">Visit #{visitNumber}</span>                  </span>                )}
              </h3>
              <button
