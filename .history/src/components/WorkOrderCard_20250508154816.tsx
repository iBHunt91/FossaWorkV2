            ...
            <div className="flex items-center justify-between mb-1.5">
              ...
              {workOrder.instructions && workOrder.instructions.length > 0 && (
                <button 
                  ...
                  className="flex items-center text-xs bg-primary-50 dark:bg-primary-900/20 text-primary-600 dark:text-primary-400 hover:bg-primary-100 dark:hover:bg-primary-800/30 transition-colors px-2 py-0.5 rounded-full shadow-sm"
                >
                  {showFullInstructions ? (
                    <>
                      <FiChevronUp size={12} className="mr-1" />
                      <span>Show Less</span>
                    </>
                  ) : (
                    <>
