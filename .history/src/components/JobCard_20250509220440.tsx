  ...
  (
    ...
    return (
      ...
      >
        ...
        <div className="flex flex-wrap items-center gap-2 p-3 bg-gray-50 dark:bg-gray-800/80 border-t border-gray-200 dark:border-gray-700">
          <Button
            variant="outline"
            size="sm"
            ...
            className={cn(
              ...
              styles.accentHoverBgClass,
              "focus-visible:ring-offset-0 focus-visible:ring-1", // Adjust focus ring to be more subtle with colored borders
              "dark:focus-visible:ring-offset-0 dark:focus-visible:ring-1"
            )}
            // style={{ borderColor: styles.dot }} // Removed inline style
          >
          ...
          <Button
            ...
            // style={{ borderColor: styles.dot }} // Removed
          >
