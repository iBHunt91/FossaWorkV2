  ...
  return (
    ...
    >
      ...
      <div className="p-4 relative z-10">
        ...
        {workOrder.customer && 'contact' in workOrder.customer && workOrder.customer.contact && (
          <div className="flex items-start mb-3">
            <div className="flex-shrink-0 w-8 h-8 rounded-lg bg-gray-100 dark:bg-gray-700 flex items-center justify-center mr-3">
            ...
            <div>
              <p className="text-sm font-medium text-gray-800 dark:text-gray-200">
                {typeof workOrder.customer.contact === 'object' && 'name' in workOrder.customer.contact ? 
                  workOrder.customer.contact.name : 'Contact'}
              </p>
