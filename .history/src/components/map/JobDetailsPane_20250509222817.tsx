...
const JobDetailsPane: React.FC<JobDetailsPaneProps> = ({ selectedJob }) => {
  ...
  if (typeof selectedJob.dispenserCount === 'number') {
    ...
    // Fallback to regex checks if dispenserCount is not a number (e.g., undefined)
    console.log("JobDetailsPane: selectedJob.dispenserCount is not a number. Attempting regex fallback for description/instructions.");
