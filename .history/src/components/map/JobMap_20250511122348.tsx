    ...
    if (selectedJob && selectedJob.coordinates) {
      ...
      if (currentMarker) {
        ...
        if (enableFlyTo) {
          ...
          currentMarkerEl.style.width = '38px';
          ...
          // Apply minimal style change when not flying (View All mode)
          currentMarkerEl.style.backgroundColor = '#FF0000'; // Bright Red
          ...
          currentMarkerEl.innerHTML = defaultMarkerStyle.innerHTML;
          currentMarkerEl.style.zIndex = '10';
          currentMarkerEl.style.transform = defaultMarkerStyle.transform;
        }
