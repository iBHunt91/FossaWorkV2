...
export interface JobMapRef {
  ...
  showRouteBetweenJobs: (originJob: GeocodedJob, destinationJob: GeocodedJob) => Promise<string | null>;
}
...
const JobMap = forwardRef<JobMapRef, JobMapProps>(({ jobs, selectedJob, onSelectJob, enableFlyTo }, ref) => {
  ...
  useImperativeHandle(ref, () => ({
    ...
    showRouteBetweenJobs: async (originJob: GeocodedJob, destinationJob: GeocodedJob) => {
      const mapInstance = map.current;
      if (!mapInstance || !mapLoaded) {
