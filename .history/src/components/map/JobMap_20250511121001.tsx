  ...
  useEffect(() => {
    ...
    if (prevSelectedJobIdRef.current && prevSelectedJobIdRef.current !== selectedJob?.id) {
      ...
      if (prevMarker) {
        ...
        prevMarkerEl.style.boxShadow = '0 2px 6px rgba(0,0,0,0.5)';
    ...
    if (selectedJob && selectedJob.coordinates) {
      ...
      if (currentMarker) {
        ...
        currentMarkerEl.style.border = '4px solid white';    // Much thicker white border
        currentMarkerEl.style.width = '36px';               // Even larger
        ...
        currentMarkerEl.innerHTML = '<span style="color: white; font-size: 20px; font-weight: bold;">★</span>'; // Much larger star
