    ...
    locations.forEach(location => {
      ...
      try {
        ...
        Object.assign(markerEl.style, {
          ...
          cursor: 'pointer',
          boxShadow: '0 3px 8px rgba(0,0,0,0.6)', // Enhanced shadow
          border: '2.5px solid white', // Thicker border
          transition: 'transform 0.15s ease-out',
          zIndex: '10', // Ensure markers are above map layers
        });
        
        // Add pin icon inside marker
        markerEl.innerHTML = '<svg viewBox="0 0 24 24" width="16" height="16" stroke="white" stroke-width="3" fill="none" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path><circle cx="12" cy="10" r="3"></circle></svg>';
        ...
        console.log(`SimpleJobMap: Adding marker at [${location.lng}, ${location.lat}] for ${location.id} (${location.title})`);
