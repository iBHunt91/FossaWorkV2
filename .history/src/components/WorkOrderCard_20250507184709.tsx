            ...
            <div className="flex items-start mb-3">
              ...
              <div>
                <p className="text-sm font-medium text-gray-800 dark:text-gray-200">
                  {typeof workOrder.customer.contact === 'object' && 
                  workOrder.customer.contact !== null &&
                  'name' in workOrder.customer.contact && 
                  typeof workOrder.customer.contact.name === 'string' 
                    ? workOrder.customer.contact.name 
                    : 'Contact'}
                </p>
                {typeof workOrder.customer.contact === 'object' && 
                 workOrder.customer.contact !== null &&
                 'phone' in workOrder.customer.contact && 
                 typeof workOrder.customer.contact.phone === 'string' && (
