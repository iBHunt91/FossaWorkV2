...
// Import the fuel grades array using ES module import instead of require
import fuelGradesData from '../../data/fuel_grades';
// Type annotation for the imported data
const fuelGrades: string[] = fuelGradesData;
