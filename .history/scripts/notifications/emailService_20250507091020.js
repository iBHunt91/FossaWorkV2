...
export async function sendEmail(options) {
  try {
    ...
    console.log('1. Retrieved email settings:', {
    ...
    console.log('3. Recipient email:', recipientEmail);
    ...
    console.log('4. Sender details:', { senderName, senderEmail });
    ...
    console.log('5. Mail options prepared:', {
      to: mailOptions.to,
    ...
    try {
      ...
      console.error('10. Detailed error information:', {
        name: error.name,
    ...
    console.error('11. Error in sendEmail:', error);
