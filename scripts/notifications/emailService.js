    ...
    if (changes.high.length > 0) {
        ...
        for (const change of changes.high) {
            ...
            if (change.type === 'date_changed') {
                ...
                <p>• Job: ${change.jobId}</p>
                <p>• Store: ${change.store}</p>
                <p>• Location: ${change.location || 'Unknown'}</p>
                <p>• Dispensers: ${change.dispensers || 'Unknown'}</p>
                ...
                <p>• Job: ${change.job1Id}</p>
                <p>• Store: ${change.job1Store}</p>
                <p>• Date: ${change.oldDate1} → ${change.newDate1}</p>
                <p><strong>Job 2:</strong></p>
                <p>• Job: ${change.job2Id}</p>
                <p>• Store: ${change.job2Store}</p>
                <p>• Date: ${change.oldDate2} → ${change.newDate2}</p>`;
            }
            html += `</div>`;
        }
    }
    ...
    html += `
        <div class="footer">
            ...
            <p style="margin-top: 15px; font-size: 11px; color: #999;">
                <strong>Caution:</strong> This email originated from outside of OWL Services. Do not click links or open attachments unless you
